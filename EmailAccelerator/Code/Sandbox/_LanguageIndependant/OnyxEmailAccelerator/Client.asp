...
dim blnPagePosted
dim gstrDBConnection, gstrOptOutText, gstrOptOutURL, gstrTimageURL, gintSiteID
...
call LoadGlobalVariables(gstrDBConnection, gstrOptOutText, gstrOptOutURL, gstrTimageURL, gintSiteID)
...
private sub LoadGlobalVariables (byRef pstrDBConnection, byRef pstrOptOutText, byRef pstrOptOutURL, byRef pstrTimageURL, byRef pintSiteID)
    dim xmlConfig
    dim objErr
...
private sub doMassEmail()
    ...
    while not objRs_Recipients.eof
        ...
        strFinalMessage = strFinalMessage & "<br><img src=""" & gstrTimageURL & strViewEncoded & ".gif"" width=""10"" height=""10"" alt=""Thank you""><Br>"
        if gBlnSystemOptOut then
...
<head>
    ...
    <Table width="100%" cellspacing=0 cellpadding=0 border=0>
        <tr>
            <td width="168"><img src="images/HeaderTopLeft.jpg" width="168" height="63" alt=""></td>
            <td width="100%" background="images/headerTopMiddle.jpg"><span class="WhiteTitle">Onyx Email Accelerator</span></td>
            <td><img src="images/headerTopRight.jpg" width="32" height="63" alt=""></td>
        </tr>
    </table>
    <!--End Header-->
    <div class="mainBody">
...
<table cellpadding="5" cellspacing="0" width="700" bgColor="#efefef" class="bordered">

<tr>
<td valign="top" width="75"><strong>To:</strong></td>
<td valign="top">
<%
for i = 0 to ubound(gArrayRecipientSampling)
    response.write gArrayRecipientSampling(i) & "<br>"
next
response.write "...<br>" & cstr(gintRecipientCount) & " total recipients"
...
<table width="100%" bgcolor="#B3D7F8" class="bordered">
<tr><td width="400">
<strong>View-Email Tracking Information:</strong><br>
...
<%if gBlnSystemOptOut then%>
    ...
    <tr>
    <td>
    <strong>Opt-Out Tracking Information:</strong><br>
...
<tr>
<td valign="top">
<strong>HTML Source/Message:</strong><br>
<textarea class="formelement" cols="88" rows="30" name="HTMLMessage"><%=trim(request("HTMLMessage"))%></textarea>
</td>
</tr>
<tr>
<td valign="top">
<strong>Opt-Out Text:</strong><br>
<textarea class="formelement" cols="88" rows="5" name="optOutText">
<%
if trim(request("optOutText")) <> "" then
...
<%
if gBlnSystemOptOut then
    response.write "<strong>Opt-Out URL:</strong>" & gstrOptOutURL
end if
%>
<br>
</td></tr>
...
<td valign="top">
<br>
<table width="200" cellpadding="5" cellspacing="5" bgColor="#efefef" class="bordered">
<tr>
<td valign="top">
