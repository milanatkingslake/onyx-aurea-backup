	...
	public class ImageHandler : IHttpHandler
	{
		...
		public void ProcessRequest(System.Web.HttpContext context)
		{
			try
			{
				...
				string imageFile = ConfigurationSettings.AppSettings["GIF_FILE"];
		...
		private void SaveToDatabase(string key)
		{
			try 
			{
				...
				int siteID = Convert.ToInt32(ConfigurationSettings.AppSettings["SITEID"]);
				dbConnectionString = ConfigurationSettings.AppSettings["DBCONN_STRING"];
