...
#define _LAUNCHAPPEX_H
	...
	#define STILL_ACTIVE    0x00000103
     ...
     prototype BOOL kernel32.CreateProcessA(POINTER, BYVAL STRING, POINTER,
               ...
               POINTER);
	 prototype BOOL kernel32.CreateProcess(STRING, STRING, POINTER,
               POINTER, BOOL, NUMBER, POINTER, POINTER, POINTER,
               POINTER);
	...
	//hide app and wait	
	prototype HideAppAndWait(STRING, STRING, NUMBER);
	prototype OHideAppAndWait(STRING, STRING, NUMBER);
