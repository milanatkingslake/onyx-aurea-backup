...
namespace Avolin.Onyx.Part07.AUT.Tests.UI.Navigator.Model
{
    ...
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="Onyx.UI.Navigator.Model.TreeData" />)
    ...
    public class TreeDataTest : AbstractBaseSetupV3Test
    {
        ...
        #region General Initializer : Class (TreeData) All Properties Explore By Name

        /// <summary>
        ///     Class (<see cref="TreeData" />) explore and verify properties for coverage gain.
        /// </summary>
        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT Initializer")]
        ...
        public void AUT_TreeData_All_Properties_Explore_Verify_By_Name_Test(string name)
        {
            // Arrange
            this.ValidateExecuteCondition(name);
        ...
        {
            // Arrange
            var methodTreeDataParametersTypes = new Type[] { typeof(string), typeof(string), typeof(string), typeof(string), typeof(bool) };
        ...
        {
            // Arrange
            var methodTreeDataParametersTypes = new Type[] { typeof(string), typeof(string), typeof(string), typeof(bool) };
        ...
        #region General Getters/Setters : Class (TreeData) => all properties explore by setting value.
        ...
        [TestCase(PropertyparentNodeId)]
        [TestCase(Propertychildren)]
        public void AUT_TreeData_Property_Exist_By_Name_Verify_Test(string name)
        {
            // Arrange
            this.ValidateExecuteCondition(name);
            var propertyInfo = this.GetPropertyInfo(name);
        ...
        #region General Getters/Setters : Class (TreeData) => Property (nodeId) (Can Read) tests

        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT GetterSetter")]
        public void AUT_TreeData_Public_Class_nodeId_Coverage_For_Property_Is_Present_And_Can_Read_Test()
        {
            // Arrange
        ...
        #region General Getters/Setters : Class (TreeData) => Property (parentNodeId) (Can Read) tests

        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT GetterSetter")]
        public void AUT_TreeData_Public_Class_parentNodeId_Coverage_For_Property_Is_Present_And_Can_Read_Test()
        {
            // Arrange
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_TreeData_ToString_Method_DirectCall_Result_ShouldNotBe_Null_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodToString);
            ...
            // Act
            Action executeAction = () => returnedValue = _treeDataInstance.ToString();
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_TreeData_ToString_Method_Call_Dynamic_Invoking_Results_Should_Not_Be_Null_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodToString);
