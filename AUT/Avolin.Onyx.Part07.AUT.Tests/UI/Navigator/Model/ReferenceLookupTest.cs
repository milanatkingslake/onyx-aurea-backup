...
namespace Avolin.Onyx.Part07.AUT.Tests.UI.Navigator.Model
{
    ...
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="Onyx.UI.Navigator.Model.ReferenceLookup" />)
    ...
    public class ReferenceLookupTest : AbstractBaseSetupV3Test
    {
        ...
        #region General Constructor : Class (ReferenceLookup) with Parameter Test

        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT Constructor")]
        public void AUT_ReferenceLookup_Constructor_With_Parameter_Created_Instance_Type_Test()
        {
            // Arrange
            var source = this.CreateType<XElement>();
            ReferenceLookup instance = null;
            Exception creationException = null;

            // Act
            Action createAction = () => instance = new ReferenceLookup(source);
            ...
            _referenceLookupInstance.ShouldNotBeNull();
            _referenceLookupInstanceFixture.ShouldNotBeNull();
            instance.ShouldBeOfType<ReferenceLookup>();
        }
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT Constructor")]
        public void AUT_ReferenceLookup_Constructor_Instantiation_With_Parameter_Test()
        {
            // Arrange
            var source = this.CreateType<XElement>();
            ReferenceLookup instance = null;
        ...
        #region General Constructor : Class (ReferenceLookup) instance created
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT Constructor")]
        public void AUT_ReferenceLookup_Is_Created_Test()
        {
            // Assert
            _referenceLookupInstance.ShouldNotBeNull();
            _referenceLookupInstanceFixture.ShouldNotBeNull();
        ...
        #region General Constructor : Class (ReferenceLookup) constructors coverage gain tests by index

        /// <summary>
        ///     Class (<see cref="ReferenceLookup" />) explore and verify it's constructors by index.
        /// </summary>
        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT Constructor")]
        ...
        [TestCase(1)]
        [TestCase(2)]
        public void AUT_ReferenceLookup_Constructor_Explore_By_Index_NoThrow_Exception_Thrown_Test(int constructorIndex)
        {
            // Arrange
        ...
        #region General Constructor : Class (ReferenceLookup) constructors coverage gain tests

        /// <summary>
        ///     Explore and verify all constructors of Class (<see cref="ReferenceLookup" />).
        /// </summary>
        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT Constructor")]
        public void AUT_ReferenceLookup_All_Constructors_Explore_Verify_Test()
        {
            // Act
        ...
        #region General Constructor : Class (ReferenceLookup) constructors with dynamic parameters () coverage gain tests

        /// <summary>
        ///     Explore and verify constructors (with / without parameter) of Class (<see cref="ReferenceLookup" />).
        /// </summary>
        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT Constructor")]
        public void AUT_ReferenceLookup_Constructors_With_Dynamic_Explore_Verify_Test()
        {
            // Arrange
            var methodReferenceLookupParametersTypes = new Type[] { typeof(XElement) };

            // Assert
            this.ExploreVerifyConstructorByGivenParametersType(methodReferenceLookupParametersTypes);
        }

        #endregion

        #region General Constructor : Class (ReferenceLookup) constructors with dynamic parameters (Overloading_Of_1_) coverage gain tests
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT Constructor")]
        public void AUT_ReferenceLookup_Constructors_Overloading_Of_1_With_Dynamic_Explore_Verify_Test()
        {
            // Arrange
            var methodReferenceLookupParametersTypes = new Type[] { typeof(string), typeof(string) };
        ...
        #region General Constructor : Class (ReferenceLookup) constructors with dynamic parameters (Overloading_Of_2_) coverage gain tests
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT Constructor")]
        public void AUT_ReferenceLookup_Constructors_Overloading_Of_2_With_Dynamic_Explore_Verify_Test()
        {
            // Arrange
            Type [] methodReferenceLookupParametersTypes = null;
