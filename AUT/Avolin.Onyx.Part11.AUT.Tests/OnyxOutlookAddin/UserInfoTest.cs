...
namespace Avolin.Onyx.Part11.AUT.Tests.OnyxOutlookAddin
{
    ...
    public partial class UserInfoTest : AbstractBaseSetupV3Test
    {
        /// <summary>
        ///     Automatic Unit Tests for a public class (<see cref="UserInfo" />)
        /// </summary>
        public UserInfoTest() : base(typeof(UserInfo))
        { }
        ...
        private UserInfo _userInfoInstanceFixture;
        ...
        {
            _userInfoInstanceType = typeof(UserInfo);
            _userInfoInstanceFixture = this.Create<UserInfo>(false);
            _userInfoInstance = _userInfoInstanceFixture ?? this.Create<UserInfo>(true);
        ...
        public void AUT_UserInfo_Explore_Reflection_Based_NonListed_Methods_Test()
        {
            // Arrange
        ...
        [Category("AUT Slow Tests")]
        [Category("AUT Explore")]
        public void AUT_UserInfo_Explore_Reflection_Based_NonListed_Properties_Test()
        {
            // Arrange
        ...
        [Category("AUT Slow Tests")]
        [Category("AUT Explore")]
        public void AUT_UserInfo_Explore_Reflection_Based_NonListed_Fields_Test()
        {
            // Arrange
        ...
        public void AUT_UserInfo_All_Methods_Explore_Verify_Test(string name, int overloadingIndex = 0)
        {
            // Arrange
        ...
        #region General Initializer : Class (UserInfo) All Properties Explore By Name

        /// <summary>
        ///     Class (<see cref="UserInfo" />) explore and verify properties for coverage gain.
        /// </summary>
        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT Initializer")]
        ...
        public void AUT_UserInfo_All_Properties_Explore_Verify_By_Name_Test(string name)
        {
            // Arrange
            this.ValidateExecuteCondition(name);
        ...
        [Category("AUT Fields")]
        public void AUT_UserInfo_All_Fields_Explore_Verify_By_Name_Test(string name)
        {
            // Arrange
            this.ValidateExecuteCondition(name);
        ...
        #region General Instance : Class (UserInfo) Static Class or Instance Creation

        /// <summary>
        ///     Class (<see cref="UserInfo" />) can be created test
        /// </summary>
        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT Instance")]
        public void AUT_UserInfo_Is_Instance_Present_Test()
        {
            // Assert
            _userInfoInstanceType.ShouldNotBeNull();
            _userInfoInstance.ShouldNotBeNull();
            _userInfoInstanceFixture.ShouldNotBeNull();
            CurrentInstance.ShouldNotBeNull();
        }

        #endregion

        #region General Instance : Class (UserInfo) Instance Type Verify Test

        /// <summary>
        ///     Class (<see cref="UserInfo" />) instance type verify test.
        /// </summary>
        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT Instance")]
        public void AUT_UserInfo_Is_Instance_Type_Verify_Test()
        {
            // Assert
            _userInfoInstance.ShouldBeAssignableTo<UserInfo>();
            _userInfoInstanceFixture.ShouldBeAssignableTo<UserInfo>();
            CurrentInstance.ShouldBeAssignableTo<UserInfo>();
        }
        ...
        #region General Constructor : Class (UserInfo) with Parameter Test

        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT Constructor")]
        public void AUT_UserInfo_Constructor_With_Parameter_Created_Instance_Type_Test()
        {
            // Arrange
            var paramUser = this.CreateType<OnyxUser>();
            var paramInfoPanel = this.CreateType<OnyxInfoPanel>();
            UserInfo instance = null;
            Exception creationException = null;

            // Act
            Action createAction = () => instance = new UserInfo(paramUser, paramInfoPanel);
            ...
            _userInfoInstance.ShouldNotBeNull();
            _userInfoInstanceFixture.ShouldNotBeNull();
            instance.ShouldBeOfType<UserInfo>();
        }
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT Constructor")]
        public void AUT_UserInfo_Constructor_Instantiation_With_Parameter_Test()
        {
            // Arrange
            var paramUser = this.CreateType<OnyxUser>();
            var paramInfoPanel = this.CreateType<OnyxInfoPanel>();
        ...
        #region General Getters/Setters : Class (UserInfo) => all properties explore by setting value.
        ...
        [TestCase(PropertyIsNeedsRefresh)]
        [TestCase(PropertyCustomControlId)]
        public void AUT_UserInfo_Property_Exist_By_Name_Verify_Test(string name)
        {
            // Arrange
            this.ValidateExecuteCondition(name);
            var propertyInfo = this.GetPropertyInfo(name);
        ...
        #region General Getters/Setters : Class (UserInfo) => Property (CustomControlId) Property Type Test Except String

        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT GetterSetter")]
        public void AUT_UserInfo_CustomControlId_Property_Setting_String_Throw_Argument_Exception_Test()
        {
            // Arrange
            ...
            Action currentAction = () => propertyInfo.SetValue(_userInfoInstance, randomString, null);
        ...
        #region General Getters/Setters : Class (UserInfo) => Property (CustomControlId) (Can Read) tests

        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT GetterSetter")]
        public void AUT_UserInfo_Public_Class_CustomControlId_Coverage_For_Property_Is_Present_And_Can_Read_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(PropertyCustomControlId);
            var propertyInfo = this.GetPropertyInfo(PropertyCustomControlId);
        ...
        #region General Getters/Setters : Class (UserInfo) => Property (Id) Property Type Test Except String

        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT GetterSetter")]
        public void AUT_UserInfo_Id_Property_Setting_String_Throw_Argument_Exception_Test()
        {
            // Arrange
        ...
        #region General Getters/Setters : Class (UserInfo) => Property (Id) (Can Read) tests

        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT GetterSetter")]
        public void AUT_UserInfo_Public_Class_Id_Coverage_For_Property_Is_Present_And_Can_Read_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(PropertyId);
            var propertyInfo = this.GetPropertyInfo(PropertyId);
        ...
        #region General Getters/Setters : Class (UserInfo) => Property (IsNeedsRefresh) (Can Read) tests

        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT GetterSetter")]
        public void AUT_UserInfo_Public_Class_IsNeedsRefresh_Coverage_For_Property_Is_Present_And_Can_Read_Test()
        {
            // Arrange
        ...
        #region General Getters/Setters : Class (UserInfo) => Property (IsPopulated) (Can Read) tests

        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT GetterSetter")]
        public void AUT_UserInfo_Public_Class_IsPopulated_Coverage_For_Property_Is_Present_And_Can_Read_Test()
        {
            // Arrange
        ...
        public void AUT_UserInfo_AddControlToTree_Method_DirectCall_Throw_Exception_Test()
        {
            // Arrange
            ...
            // Act
            Action executeAction = () => _userInfoInstance.AddControlToTree(parentControlId);
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_UserInfo_AddControlToTree_Method_Call_Void_With_No_Parameters_Call_Throw_Exception_Thrown_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodAddControlToTree);
            var parentControlId = this.CreateType<string>();
            ...
            // Act
            Action currentAction = () => currentMethodInfo.Invoke(_userInfoInstanceFixture, parametersOfAddControlToTree);
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_UserInfo_AddControlToTree_Method_Call_Void_With_No_Parameters_Call_No_Exception_Thrown_With_Encapsulation_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodAddControlToTree);
            var parentControlId = this.CreateType<string>();
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_UserInfo_AddControlToTree_Method_Call_Parameters_Count_Verification_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodAddControlToTree);
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_UserInfo_AddControlToTree_Method_Call_Dynamic_Invoking_Should_Not_Throw_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodAddControlToTree);
            var methodAddControlToTreeParametersTypes = new Type[] { typeof(String) };
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_UserInfo_AddControlToTree_Method_Call_With_Dynamic_Invoking_Without_Parameters_Should_Not_Throw_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodAddControlToTree);
            var currentMethodInfo = this.GetMethodInfo(MethodAddControlToTree, 0);
        ...
        [ExcludeFromCodeCoverage]
        private void AUT_UserInfo_PopulateControl_Method_Call_Internally(Type[] types)
        {
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_UserInfo_PopulateControl_Method_DirectCall_Throw_Exception_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodPopulateControl);

            // Act
            Action executeAction = () => _userInfoInstance.PopulateControl();
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_UserInfo_PopulateControl_Method_Call_Void_With_No_Parameters_Call_Throw_Exception_Thrown_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodPopulateControl);
            ...
            // Act
            Action currentAction = () => currentMethodInfo.Invoke(_userInfoInstanceFixture, parametersOfPopulateControl);
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_UserInfo_PopulateControl_Method_Call_Void_With_No_Parameters_Call_No_Exception_Thrown_With_Encapsulation_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodPopulateControl);
            Type [] methodPopulateControlParametersTypes = null;
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_UserInfo_PopulateControl_Method_Call_Dynamic_Invoking_Should_Not_Throw_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodPopulateControl);
            Type [] methodPopulateControlParametersTypes = null;
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_UserInfo_PopulateControl_Method_Call_With_Dynamic_Invoking_Without_Parameters_Should_Not_Throw_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodPopulateControl);
        ...
        [ExcludeFromCodeCoverage]
        private void AUT_UserInfo_populateCustomerInfo_Method_Call_Internally(Type[] types)
        {
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_UserInfo_populateCustomerInfo_Method_Call_Void_With_No_Parameters_Call_Throw_Exception_Thrown_Test()
        {
            // Arrange
            ...
            // Act
            Action currentAction = () => currentMethodInfo.Invoke(_userInfoInstanceFixture, parametersOfpopulateCustomerInfo);
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_UserInfo_populateCustomerInfo_Method_Call_Void_With_No_Parameters_Call_No_Exception_Thrown_With_Encapsulation_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodpopulateCustomerInfo);
            Type [] methodpopulateCustomerInfoParametersTypes = null;
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_UserInfo_populateCustomerInfo_Method_Call_Dynamic_Invoking_Should_Not_Throw_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodpopulateCustomerInfo);
            Type [] methodpopulateCustomerInfoParametersTypes = null;
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_UserInfo_populateCustomerInfo_Method_Call_With_Dynamic_Invoking_Without_Parameters_Should_Not_Throw_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodpopulateCustomerInfo);
        ...
        [ExcludeFromCodeCoverage]
        private void AUT_UserInfo_createTextBox_Method_Call_Internally(Type[] types)
        {
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_UserInfo_createTextBox_Method_Call_With_No_Parameters_Call_Results_ShouldBe_Null_If_Not_Premitive_Type_Test()
        {
            // Arrange
            ...
            // Act
            var result1 = currentMethodInfo.GetResultMethodInfo<TextBox>(_userInfoInstanceFixture, parametersOfcreateTextBox);
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_UserInfo_createTextBox_Method_Call_With_Call_No_Exception_Thrown_With_Encapsulation_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodcreateTextBox);
            var label = this.CreateType<string>();
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_UserInfo_createTextBox_Method_Call_Dynamic_Invoking_Results_Null_If_Not_Primitive_Type_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodcreateTextBox);
            var methodcreateTextBoxParametersTypes = new Type[] { typeof(String), typeof(String) };
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_UserInfo_createTextBox_Method_Call_Dynamic_Invoking_Should_Not_Throw_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodcreateTextBox);
            var methodcreateTextBoxParametersTypes = new Type[] { typeof(String), typeof(String) };
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_UserInfo_createTextBox_Method_Call_Dynamic_Invoking_Results_Should_Be_Null_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodcreateTextBox);
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_UserInfo_createTextBox_Method_Call_Parameters_Count_Verification_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodcreateTextBox);
            var currentMethodInfo = this.GetMethodInfo(MethodcreateTextBox, 0);
        ...
        [ExcludeFromCodeCoverage]
        private void AUT_UserInfo_addChildListControls_Method_Call_Internally(Type[] types)
        {
        ...
        #region Method Call : (addChildListControls) (Return Type : void) Exception Thrown

        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_UserInfo_addChildListControls_Method_Call_Void_With_No_Parameters_Call_Throw_Exception_Thrown_Test()
        {
            // Arrange
            ...
            // Act
            Action currentAction = () => currentMethodInfo.Invoke(_userInfoInstanceFixture, parametersOfaddChildListControls);
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_UserInfo_addChildListControls_Method_Call_Void_With_No_Parameters_Call_No_Exception_Thrown_With_Encapsulation_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodaddChildListControls);
            Type [] methodaddChildListControlsParametersTypes = null;
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_UserInfo_addChildListControls_Method_Call_Dynamic_Invoking_Should_Not_Throw_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodaddChildListControls);
            Type [] methodaddChildListControlsParametersTypes = null;
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_UserInfo_addChildListControls_Method_Call_With_Dynamic_Invoking_Without_Parameters_Should_Not_Throw_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodaddChildListControls);
        ...
        [ExcludeFromCodeCoverage]
        private void AUT_UserInfo_ResetTableLayoutPanels_Method_Call_Internally(Type[] types)
        {
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_UserInfo_ResetTableLayoutPanels_Method_DirectCall_No_Exception_Thrown_Test()
        {
            // Arrange
            ...
            // Act
            Action executeAction = () => _userInfoInstance.ResetTableLayoutPanels(bVisible);
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_UserInfo_ResetTableLayoutPanels_Method_Call_Void_With_No_Parameters_No_Exception_Thrown_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodResetTableLayoutPanels);
            var bVisible = this.CreateType<bool>();
            ...
            // Act
            Action currentAction = () => currentMethodInfo.Invoke(_userInfoInstanceFixture, parametersOfResetTableLayoutPanels);
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_UserInfo_ResetTableLayoutPanels_Method_Call_Void_With_No_Parameters_Call_No_Exception_Thrown_With_Encapsulation_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodResetTableLayoutPanels);
            var bVisible = this.CreateType<bool>();
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_UserInfo_ResetTableLayoutPanels_Method_Call_Parameters_Count_Verification_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodResetTableLayoutPanels);
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_UserInfo_ResetTableLayoutPanels_Method_Call_Dynamic_Invoking_Should_Not_Throw_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodResetTableLayoutPanels);
            var methodResetTableLayoutPanelsParametersTypes = new Type[] { typeof(bool) };
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_UserInfo_ResetTableLayoutPanels_Method_Call_With_Dynamic_Invoking_Without_Parameters_Should_Not_Throw_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodResetTableLayoutPanels);
            var currentMethodInfo = this.GetMethodInfo(MethodResetTableLayoutPanels, 0);
