...
namespace Avolin.Onyx.Part11.AUT.Tests.OnyxOutlookAddin
{
    ...
    public partial class DuplicateCustomersDesignerTest : AbstractBaseSetupV3Test
    {
        /// <summary>
        ///     Automatic Unit Tests for a non-public class (<see cref="DuplicateCustomersNonPublicTypeName" />) using
        ///     Using a public type <see cref="AddContactControl" /> to
        ///     create a non-public type.
        /// </summary>
        public DuplicateCustomersDesignerTest() : base(publicType: typeof(AddContactControl), classNameWithNamespace: DuplicateCustomersNonPublicTypeName)
        { }
        ...
        private const string DuplicateCustomersNonPublicTypeName = "OnyxOutlookAddin.DuplicateCustomers";

        /// <summary>
        ///    For non-public class type is defined as object.
        /// </summary>
        private object _duplicateCustomersInstance;
        private object _duplicateCustomersInstanceFixture;
        ...
        {
            _duplicateCustomersInstanceFixture = this.CreateNonPublicType(DuplicateCustomersNonPublicTypeName);
            _duplicateCustomersInstance = _duplicateCustomersInstanceFixture;
        ...
        private const string FielddupeCustomersGrid = "dupeCustomersGrid";
        ...
        public void AUT_DuplicateCustomersDesigner_All_Methods_Explore_Verify_Test(string name, int overloadingIndex = 0)
        {
            // Arrange
        ...
        [Category("AUT Explore")]
        public void AUT_DuplicateCustomersDesigner_Explore_Reflection_Based_NonListed_Methods_Test()
        {
            // Assert
        ...
        [TestCase(FielddupeCustomersGrid)]
        [Category("AUT Fields")]
        public void AUT_DuplicateCustomersDesigner_All_Fields_Explore_Verify_By_Name_Test(string name)
        {
            // Arrange
            this.ValidateExecuteCondition(name);
        ...
        [Category("AUT Slow Tests")]
        [Category("AUT Explore")]
        public void AUT_DuplicateCustomersDesigner_Explore_Reflection_Based_NonListed_Fields_Test()
        {
            // Assert
