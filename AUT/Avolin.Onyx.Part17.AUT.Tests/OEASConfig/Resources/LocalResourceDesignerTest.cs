...
using OEASConfig.Resources;
using Shouldly;

namespace Avolin.Onyx.Part17.AUT.Tests.OEASConfig.Resources
{
    using Action = System.Action;
    using Should = Shouldly.Should;

    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="OEASConfig.Resources.LocalResource" />)
    ///     and namespace <see cref="OEASConfig.Resources"/> class using generator(v:0.2.5)'s
    ...
    {
        /// <summary>
        ///     Automatic Unit Tests for a public class (<see cref="LocalResource" />)
        /// </summary>
        public LocalResourceDesignerTest() : base(typeof(LocalResource))
        { }
        ...
        private LocalResource _localResourceInstance;
        private LocalResource _localResourceInstanceFixture;
        ...
        {
            _localResourceInstanceType = typeof(LocalResource);
            _localResourceInstanceFixture = this.Create<LocalResource>(false);
            _localResourceInstance = _localResourceInstanceFixture ?? this.Create<LocalResource>(true);
        ...
        #region General Instance : Class (LocalResource) Static Class or Instance Creation

        /// <summary>
        ///     Class (<see cref="LocalResource" />) can be created test
        /// </summary>
        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT Instance")]
        public void AUT_LocalResourceDesigner_Is_Instance_Present_Test()
        {
            // Assert
            _localResourceInstanceType.ShouldNotBeNull();
            _localResourceInstance.ShouldNotBeNull();
            _localResourceInstanceFixture.ShouldNotBeNull();
            CurrentInstance.ShouldNotBeNull();
        }

        #endregion

        #region General Instance : Class (LocalResource) Instance Type Verify Test

        /// <summary>
        ///     Class (<see cref="LocalResource" />) instance type verify test.
        /// </summary>
        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT Instance")]
        public void AUT_LocalResourceDesigner_Is_Instance_Type_Verify_Test()
        {
            // Assert
            _localResourceInstance.ShouldBeAssignableTo<LocalResource>();
            _localResourceInstanceFixture.ShouldBeAssignableTo<LocalResource>();
            CurrentInstance.ShouldBeAssignableTo<LocalResource>();
        }
