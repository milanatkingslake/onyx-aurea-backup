...
namespace Avolin.Onyx.Part09.AUT.Tests.ONS.AdapterExtension.Template
{
    ...
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="Onyx.ONS.AdapterExtension.Template.IndividualFilterTemplate" />)
    ///     and namespace <see cref="Onyx.ONS.AdapterExtension.Template"/> class using generator(v:0.2.5)'s
    ///     artificial intelligence. Compatible with <see cref="AUT.TestProjects.GenV3" /> v1.2+.
    /// </summary>
    [TestFixture]
    [ExcludeFromCodeCoverage]
    public class IndividualFilterTemplateTest : AbstractBaseSetupV3Test
    {
        /// <summary>
        ///     Automatic Unit Tests for a public class (<see cref="IndividualFilterTemplate" />)
        /// </summary>
        public IndividualFilterTemplateTest() : base(typeof(IndividualFilterTemplate))
        { }
        ...
        #region General Initializer : Class (IndividualFilterTemplate) One time setup

        private const int TestsTimeOut = TestContants.TimeOutEightSeconds;
        private Type _individualFilterTemplateInstanceType;
        private IndividualFilterTemplate _individualFilterTemplateInstance;
        private IndividualFilterTemplate _individualFilterTemplateInstanceFixture;

        /// <summary>
        ///    Setting up everything for <see cref="IndividualFilterTemplate" /> one time.
        /// </summary>
        [OneTimeSetUp]
        [ExcludeFromCodeCoverage]
        public override void OneTimeSetup()
        {
            _individualFilterTemplateInstanceType = typeof(IndividualFilterTemplate);
            _individualFilterTemplateInstanceFixture = this.Create<IndividualFilterTemplate>(false);
            _individualFilterTemplateInstance = _individualFilterTemplateInstanceFixture ?? this.Create<IndividualFilterTemplate>(true);
            CurrentInstance = _individualFilterTemplateInstance;
        ...
        #region General Initializer : Class (IndividualFilterTemplate) Initializer
        ...
        #region General Initializer : Class (IndividualFilterTemplate) Explore Non-listed Methods

        /// <summary>
        ///     Class (<see cref="IndividualFilterTemplate" />) explore and verify methods for coverage gain which is not listed in the constants.
        /// </summary>
        [Test]
        ...
        public void AUT_IndividualFilterTemplate_Explore_Reflection_Based_NonListed_Methods_Test()
        {
            // Arrange
        ...
        #region General Initializer : Class (IndividualFilterTemplate) Explore Non-listed Fields

        /// <summary>
        ///     Class (<see cref="IndividualFilterTemplate" />) explore and verify fields for coverage gain which is not listed in the constants.
        /// </summary>
        [Test]
        [Timeout(TestContants.TimeOutFortySeconds)]
        [Category("AUT Reflection NonListed")]
        [Category("AUT Slow Tests")]
        [Category("AUT Explore")]
        public void AUT_IndividualFilterTemplate_Explore_Reflection_Based_NonListed_Fields_Test()
        {
            // Arrange
        ...
        #region Explore Class for Coverage Gain : Class (IndividualFilterTemplate)

        #region General Initializer : Class (IndividualFilterTemplate) All Methods Explore Verification.

        /// <summary>
        ///     Class (<see cref="IndividualFilterTemplate" />) explore and verify fields for coverage gain.
        /// </summary>
        [Test]
        ...
        public void AUT_IndividualFilterTemplate_All_Methods_Explore_Verify_Test(string name, int overloadingIndex = 0)
        {
            // Arrange
        ...
        #region General Initializer : Class (IndividualFilterTemplate) All Fields Explore By Name
        ...
        [Category("AUT Fields")]
        public void AUT_IndividualFilterTemplate_All_Fields_Explore_Verify_By_Name_Test(string name)
        {
            // Arrange
            this.ValidateExecuteCondition(name);
        ...
        #region General Instance : Class (IndividualFilterTemplate) Static Class or Instance Creation

        /// <summary>
        ///     Class (<see cref="IndividualFilterTemplate" />) can be created test
        /// </summary>
        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT Instance")]
        public void AUT_IndividualFilterTemplate_Is_Instance_Present_Test()
        {
            // Assert
            _individualFilterTemplateInstanceType.ShouldNotBeNull();
            _individualFilterTemplateInstance.ShouldNotBeNull();
            _individualFilterTemplateInstanceFixture.ShouldNotBeNull();
            CurrentInstance.ShouldNotBeNull();
        }

        #endregion

        #region General Instance : Class (IndividualFilterTemplate) Instance Type Verify Test

        /// <summary>
        ///     Class (<see cref="IndividualFilterTemplate" />) instance type verify test.
        /// </summary>
        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT Instance")]
        public void AUT_IndividualFilterTemplate_Is_Instance_Type_Verify_Test()
        {
            // Assert
            _individualFilterTemplateInstance.ShouldBeAssignableTo<IndividualFilterTemplate>();
            _individualFilterTemplateInstanceFixture.ShouldBeAssignableTo<IndividualFilterTemplate>();
            CurrentInstance.ShouldBeAssignableTo<IndividualFilterTemplate>();
        }
        ...
        #region General Constructor : Class (IndividualFilterTemplate) with Parameter Test

        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT Constructor")]
        public void AUT_IndividualFilterTemplate_Constructor_With_Parameter_Created_Instance_Type_Test()
        {
            // Arrange
            var config = this.CreateType<XElement>();
            IndividualFilterTemplate instance = null;
            Exception creationException = null;

            // Act
            Action createAction = () => instance = new IndividualFilterTemplate(config);
            ...
            _individualFilterTemplateInstance.ShouldNotBeNull();
            _individualFilterTemplateInstanceFixture.ShouldNotBeNull();
            instance.ShouldBeOfType<IndividualFilterTemplate>();
        }
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT Constructor")]
        public void AUT_IndividualFilterTemplate_Constructor_Instantiation_With_Parameter_Test()
        {
            // Arrange
            var config = this.CreateType<XElement>();
            IndividualFilterTemplate instance = null;
        ...
        public void AUT_IndividualFilterTemplate_ValidateEventData_Method_DirectCall_No_Exception_Thrown_Test()
        {
            // Arrange
            ...
            // Act
            Action executeAction = () => _individualFilterTemplateInstance.ValidateEventData(eventData);
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_IndividualFilterTemplate_ValidateEventData_Method_Call_With_No_Parameters_Call_Results_ShouldBe_Null_If_Not_Premitive_Type_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodValidateEventData);
            var eventData = this.CreateType<XElement>();
            ...
            // Act
            var result1 = currentMethodInfo.GetResultMethodInfo<bool>(_individualFilterTemplateInstanceFixture, parametersOfValidateEventData);
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_IndividualFilterTemplate_ValidateEventData_Method_Call_With_Results_Should_Not_Be_Null_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodValidateEventData);
            var eventData = this.CreateType<XElement>();
            ...
            // Act
            var result1 = currentMethodInfo.GetResultMethodInfo<bool>(_individualFilterTemplateInstanceFixture, out exception1, parametersOfValidateEventData);
            var result2 = this.GetResultOfMethod<bool>(MethodValidateEventData, parametersOfValidateEventData, methodValidateEventDataParametersTypes);
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_IndividualFilterTemplate_ValidateEventData_Method_Call_With_No_Exception_Thrown_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodValidateEventData);
            var eventData = this.CreateType<XElement>();
            ...
            // Act
            Action currentAction = () => currentMethodInfo.Invoke(_individualFilterTemplateInstanceFixture, parametersOfValidateEventData);
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_IndividualFilterTemplate_ValidateEventData_Method_Call_With_Call_No_Exception_Thrown_With_Encapsulation_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodValidateEventData);
            var eventData = this.CreateType<XElement>();
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_IndividualFilterTemplate_ValidateEventData_Method_Call_Dynamic_Invoking_Results_Null_If_Not_Primitive_Type_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodValidateEventData);
            var methodValidateEventDataParametersTypes = new Type[] { typeof(XElement) };
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_IndividualFilterTemplate_ValidateEventData_Method_Call_Dynamic_Invoking_Results_Not_Null_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodValidateEventData);
            var methodValidateEventDataParametersTypes = new Type[] { typeof(XElement) };
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_IndividualFilterTemplate_ValidateEventData_Method_Call_Dynamic_Invoking_Should_Not_Throw_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodValidateEventData);
            var methodValidateEventDataParametersTypes = new Type[] { typeof(XElement) };
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_IndividualFilterTemplate_ValidateEventData_Method_Call_Dynamic_Invoking_Results_Should_Not_Be_Null_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodValidateEventData);
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_IndividualFilterTemplate_ValidateEventData_Method_Call_Parameters_Count_Verification_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodValidateEventData);
            var currentMethodInfo = this.GetMethodInfo(MethodValidateEventData, 0);
        ...
        [ExcludeFromCodeCoverage]
        private void AUT_IndividualFilterTemplate_RemoveText_Method_Call_Internally(Type[] types)
        {
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_IndividualFilterTemplate_RemoveText_Method_DirectCall_No_Exception_Thrown_Test()
        {
            // Arrange
            ...
            // Act
            Action executeAction = () => _individualFilterTemplateInstance.RemoveText(eventData, actionElement);
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_IndividualFilterTemplate_RemoveText_Method_Call_Void_With_No_Parameters_No_Exception_Thrown_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodRemoveText);
            var eventData = this.CreateType<XElement>();
            ...
            // Act
            Action currentAction = () => currentMethodInfo.Invoke(_individualFilterTemplateInstanceFixture, parametersOfRemoveText);
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_IndividualFilterTemplate_RemoveText_Method_Call_Void_With_No_Parameters_Call_No_Exception_Thrown_With_Encapsulation_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodRemoveText);
            var eventData = this.CreateType<XElement>();
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_IndividualFilterTemplate_RemoveText_Method_Call_Parameters_Count_Verification_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodRemoveText);
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_IndividualFilterTemplate_RemoveText_Method_Call_Dynamic_Invoking_Should_Not_Throw_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodRemoveText);
            var methodRemoveTextParametersTypes = new Type[] { typeof(XElement), typeof(XElement) };
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_IndividualFilterTemplate_RemoveText_Method_Call_With_Dynamic_Invoking_Without_Parameters_Should_Not_Throw_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodRemoveText);
            var currentMethodInfo = this.GetMethodInfo(MethodRemoveText, 0);
        ...
        [ExcludeFromCodeCoverage]
        private void AUT_IndividualFilterTemplate_DeleteChildObject_Method_Call_Internally(Type[] types)
        {
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_IndividualFilterTemplate_DeleteChildObject_Method_DirectCall_No_Exception_Thrown_Test()
        {
            // Arrange
            ...
            // Act
            Action executeAction = () => _individualFilterTemplateInstance.DeleteChildObject(eventData, actionElement);
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_IndividualFilterTemplate_DeleteChildObject_Method_Call_Void_With_No_Parameters_No_Exception_Thrown_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodDeleteChildObject);
            var eventData = this.CreateType<XElement>();
            ...
            // Act
            Action currentAction = () => currentMethodInfo.Invoke(_individualFilterTemplateInstanceFixture, parametersOfDeleteChildObject);
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_IndividualFilterTemplate_DeleteChildObject_Method_Call_Void_With_No_Parameters_Call_No_Exception_Thrown_With_Encapsulation_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodDeleteChildObject);
            var eventData = this.CreateType<XElement>();
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_IndividualFilterTemplate_DeleteChildObject_Method_Call_Parameters_Count_Verification_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodDeleteChildObject);
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_IndividualFilterTemplate_DeleteChildObject_Method_Call_Dynamic_Invoking_Should_Not_Throw_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodDeleteChildObject);
            var methodDeleteChildObjectParametersTypes = new Type[] { typeof(XElement), typeof(XElement) };
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_IndividualFilterTemplate_DeleteChildObject_Method_Call_With_Dynamic_Invoking_Without_Parameters_Should_Not_Throw_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodDeleteChildObject);
            var currentMethodInfo = this.GetMethodInfo(MethodDeleteChildObject, 0);
        ...
        [ExcludeFromCodeCoverage]
        private void AUT_IndividualFilterTemplate_DiscardInvalidEvent_Method_Call_Internally(Type[] types)
        {
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_IndividualFilterTemplate_DiscardInvalidEvent_Method_DirectCall_Throw_Exception_Test()
        {
            // Arrange
            ...
            // Act
            Action executeAction = () => _individualFilterTemplateInstance.DiscardInvalidEvent(eventData, actionElement);
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_IndividualFilterTemplate_DiscardInvalidEvent_Method_Call_With_No_Parameters_Call_Results_ShouldBe_Null_If_Not_Premitive_Type_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodDiscardInvalidEvent);
            var eventData = this.CreateType<XElement>();
            ...
            // Act
            var result1 = currentMethodInfo.GetResultMethodInfo<bool>(_individualFilterTemplateInstanceFixture, parametersOfDiscardInvalidEvent);
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_IndividualFilterTemplate_DiscardInvalidEvent_Method_Call_With_Results_Should_Not_Be_Null_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodDiscardInvalidEvent);
            var eventData = this.CreateType<XElement>();
            ...
            // Act
            var result1 = currentMethodInfo.GetResultMethodInfo<bool>(_individualFilterTemplateInstanceFixture, out exception1, parametersOfDiscardInvalidEvent);
            var result2 = this.GetResultOfMethod<bool>(MethodDiscardInvalidEvent, parametersOfDiscardInvalidEvent, methodDiscardInvalidEventParametersTypes);
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_IndividualFilterTemplate_DiscardInvalidEvent_Method_Call_With_Call_No_Exception_Thrown_With_Encapsulation_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodDiscardInvalidEvent);
            var eventData = this.CreateType<XElement>();
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_IndividualFilterTemplate_DiscardInvalidEvent_Method_Call_Dynamic_Invoking_Should_Not_Throw_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodDiscardInvalidEvent);
            var methodDiscardInvalidEventParametersTypes = new Type[] { typeof(XElement), typeof(XElement) };
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_IndividualFilterTemplate_DiscardInvalidEvent_Method_Call_Dynamic_Invoking_Results_Should_Be_Null_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodDiscardInvalidEvent);
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_IndividualFilterTemplate_DiscardInvalidEvent_Method_Call_Parameters_Count_Verification_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodDiscardInvalidEvent);
            var currentMethodInfo = this.GetMethodInfo(MethodDiscardInvalidEvent, 0);
        ...
        [ExcludeFromCodeCoverage]
        private void AUT_IndividualFilterTemplate_PreprocessCustomImplementation_Method_Call_Internally(Type[] types)
        {
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_IndividualFilterTemplate_PreprocessCustomImplementation_Method_DirectCall_Throw_Exception_Test()
        {
            // Arrange
            ...
            // Act
            Action executeAction = () => _individualFilterTemplateInstance.PreprocessCustomImplementation(eventData, actionElement);
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_IndividualFilterTemplate_PreprocessCustomImplementation_Method_Call_Void_With_No_Parameters_Call_Throw_Exception_Thrown_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodPreprocessCustomImplementation);
            var eventData = this.CreateType<XElement>();
            ...
            // Act
            Action currentAction = () => currentMethodInfo.Invoke(_individualFilterTemplateInstanceFixture, parametersOfPreprocessCustomImplementation);
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_IndividualFilterTemplate_PreprocessCustomImplementation_Method_Call_Void_With_No_Parameters_Call_No_Exception_Thrown_With_Encapsulation_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodPreprocessCustomImplementation);
            var eventData = this.CreateType<XElement>();
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_IndividualFilterTemplate_PreprocessCustomImplementation_Method_Call_Parameters_Count_Verification_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodPreprocessCustomImplementation);
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_IndividualFilterTemplate_PreprocessCustomImplementation_Method_Call_Dynamic_Invoking_Should_Not_Throw_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodPreprocessCustomImplementation);
            var methodPreprocessCustomImplementationParametersTypes = new Type[] { typeof(XElement), typeof(XElement) };
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_IndividualFilterTemplate_PreprocessCustomImplementation_Method_Call_With_Dynamic_Invoking_Without_Parameters_Should_Not_Throw_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodPreprocessCustomImplementation);
            var currentMethodInfo = this.GetMethodInfo(MethodPreprocessCustomImplementation, 0);
        ...
        [ExcludeFromCodeCoverage]
        private void AUT_IndividualFilterTemplate_FilterEventDataCustomImplementation_Method_Call_Internally(Type[] types)
        {
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_IndividualFilterTemplate_FilterEventDataCustomImplementation_Method_DirectCall_Throw_Exception_Test()
        {
            // Arrange
            ...
            // Act
            Action executeAction = () => _individualFilterTemplateInstance.FilterEventDataCustomImplementation(eventData, actionElement);
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_IndividualFilterTemplate_FilterEventDataCustomImplementation_Method_Call_With_No_Parameters_Call_Results_ShouldBe_Null_If_Not_Premitive_Type_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodFilterEventDataCustomImplementation);
            var eventData = this.CreateType<XElement>();
            ...
            // Act
            var result1 = currentMethodInfo.GetResultMethodInfo<bool>(_individualFilterTemplateInstanceFixture, parametersOfFilterEventDataCustomImplementation);
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_IndividualFilterTemplate_FilterEventDataCustomImplementation_Method_Call_With_Results_Should_Not_Be_Null_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodFilterEventDataCustomImplementation);
            var eventData = this.CreateType<XElement>();
            ...
            // Act
            var result1 = currentMethodInfo.GetResultMethodInfo<bool>(_individualFilterTemplateInstanceFixture, out exception1, parametersOfFilterEventDataCustomImplementation);
            var result2 = this.GetResultOfMethod<bool>(MethodFilterEventDataCustomImplementation, parametersOfFilterEventDataCustomImplementation, methodFilterEventDataCustomImplementationParametersTypes);
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_IndividualFilterTemplate_FilterEventDataCustomImplementation_Method_Call_With_Call_No_Exception_Thrown_With_Encapsulation_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodFilterEventDataCustomImplementation);
            var eventData = this.CreateType<XElement>();
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_IndividualFilterTemplate_FilterEventDataCustomImplementation_Method_Call_Dynamic_Invoking_Should_Not_Throw_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodFilterEventDataCustomImplementation);
            var methodFilterEventDataCustomImplementationParametersTypes = new Type[] { typeof(XElement), typeof(XElement) };
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_IndividualFilterTemplate_FilterEventDataCustomImplementation_Method_Call_Dynamic_Invoking_Results_Should_Be_Null_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodFilterEventDataCustomImplementation);
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_IndividualFilterTemplate_FilterEventDataCustomImplementation_Method_Call_Parameters_Count_Verification_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodFilterEventDataCustomImplementation);
            var currentMethodInfo = this.GetMethodInfo(MethodFilterEventDataCustomImplementation, 0);
