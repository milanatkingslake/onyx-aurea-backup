...
namespace Avolin.Onyx.Part01.AUT.Tests.CmService.Service
{
    ...
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="CmService.Service.Quote" />)
    ...
    ///     Original source code location <see cref="\OnyxGatewayService\Service\Quote.cs"/>
    /// </summary>
    [TestFixture]
    [ExcludeFromCodeCoverage]
    public class QuoteTest : AbstractBaseSetupV3Test
    {
        /// <summary>
        ...
        #region General Initializer : Class (Quote) Explore Non-listed Properties

        /// <summary>
        ///     Class (<see cref="Quote" />) explore and verify properties for coverage gain which is not listed in the constants.
        /// </summary>
        [Test]
        [Timeout(TestContants.TimeOutFortySeconds)]
        [Category("AUT Reflection NonListed")]
        [Category("AUT Slow Tests")]
        [Category("AUT Explore")]
        public void AUT_Quote_Explore_Reflection_Based_NonListed_Properties_Test()
        {
            // Arrange
        ...
        #region General Initializer : Class (Quote) All Properties Explore By Name

        /// <summary>
        ///     Class (<see cref="Quote" />) explore and verify properties for coverage gain.
        /// </summary>
        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT Initializer")]
        ...
        public void AUT_Quote_All_Properties_Explore_Verify_By_Name_Test(string name)
        {
            // Arrange
            this.ValidateExecuteCondition(name);
        ...
        #region General Constructor : Class (Quote) without Parameter Test

        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT Constructor")]
        public void AUT_Quote_Instantiated_Without_Parameter_No_Throw_Exception_Test()
        {
            // Arrange
            Quote instance = null;
        ...
        public void AUT_Quote_Class_All_Properties_Getter_Settter_Test()
        {
        ...
        #region General Getters/Setters : Class (Quote) => all properties explore by setting value.

        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT GetterSetter")]
        [TestCase(PropertyEntityName)]
        public void AUT_Quote_Property_Exist_By_Name_Verify_Test(string name)
        {
            // Arrange
            this.ValidateExecuteCondition(name);
            var propertyInfo = this.GetPropertyInfo(name);
        ...
        #region General Getters/Setters : Class (Quote) => Property (EntityName) Property Type Test Except String

        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT GetterSetter")]
        public void AUT_Quote_EntityName_Property_Setting_String_Throw_Argument_Exception_Test()
        {
            // Arrange
            ...
            Action currentAction = () => propertyInfo.SetValue(_quoteInstance, randomString, null);
        ...
        #region General Getters/Setters : Class (Quote) => Property (EntityName) (Can Read) tests

        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT GetterSetter")]
        public void AUT_Quote_Public_Class_EntityName_Coverage_For_Property_Is_Present_And_Can_Read_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(PropertyEntityName);
            var propertyInfo = this.GetPropertyInfo(PropertyEntityName);
        ...
        #region Method Call : (GetDetailsViewById) (Return Type : Message) Test Try-Catch Verify Exception Throw - Should Not Throw

        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT TryCatch")]
        public void AUT_Quote_GetDetailsViewById_Try_Catch_Should_Not_Throw_Exception()
        {
            // Arrange
            var methodGetDetailsViewByIdParametersTypes = new Type[] { typeof(Message) };
        ...
        #region Method Call : (GetDetailsViewById) (Return Type : Message) Direct Call Exception Thrown Test
        ...
        public void AUT_Quote_GetDetailsViewById_Method_DirectCall_Throw_Exception_Test()
        {
            ...
            // Act
            Action executeAction = () => _quoteInstance.GetDetailsViewById(message);
        ...
        #region Method Call : (GetDetailsViewById) (Return Type : Message) Direct Call Result be Null Test
        ...
        public void AUT_Quote_GetDetailsViewById_Method_DirectCall_Result_ShouldBe_Null_Test()
        {
            ...
            // Act
            Action executeAction = () => returnedValue = _quoteInstance.GetDetailsViewById(message);
        ...
        #region Method Call : (GetDetailsViewById) (Return Type : Message) Results Null (if not primitive type) Test
        ...
        public void AUT_Quote_GetDetailsViewById_Method_Call_With_No_Parameters_Call_Results_ShouldBe_Null_If_Not_Premitive_Type_Test()
        {
            ...
            var message = this.CreateType<Message>();
            var methodGetDetailsViewByIdParametersTypes = new Type[] { typeof(Message) };
            object[] parametersOfGetDetailsViewById = { message };
            Exception exception;
            var currentMethodInfo = this.GetMethodInfo(MethodGetDetailsViewById, methodGetDetailsViewByIdParametersTypes, out exception);

            // Act
            var result1 = currentMethodInfo.GetResultMethodInfo<Message>(_quoteInstanceFixture, parametersOfGetDetailsViewById);
            var result2 = this.GetResultOfMethod<Message>(MethodGetDetailsViewById, parametersOfGetDetailsViewById, methodGetDetailsViewByIdParametersTypes);
            ...
            parametersOfGetDetailsViewById.ShouldNotBeNull();
            parametersOfGetDetailsViewById.Length.ShouldBe(1);
            methodGetDetailsViewByIdParametersTypes.Length.ShouldBe(1);
        }

        #endregion

        #region Method Call : (GetDetailsViewById) (Return Type : Message) No Exception with encapsulation Thrown
        ...
        public void AUT_Quote_GetDetailsViewById_Method_Call_With_Call_No_Exception_Thrown_With_Encapsulation_Test()
        {
            ...
            // Act
            Action currentAction = () => this.GetResultOfMethod<Message>(MethodGetDetailsViewById, parametersOfGetDetailsViewById, methodGetDetailsViewByIdParametersTypes);
        ...
        #region Method Call : (GetDetailsViewById) (Return Type : Message) Invoke Should Not Throw
        ...
        public void AUT_Quote_GetDetailsViewById_Method_Call_Dynamic_Invoking_Should_Not_Throw_Test()
        {
            ...
            // Assert
            Should.NotThrow(currentAction);
            methodGetDetailsViewByIdParametersTypes.Length.ShouldBe(parametersCount);
        }

        #endregion

        #region Method Call : (GetDetailsViewById) (Return Type : Message) without parameters value verify result should be null.
        ...
        #region Method Call : (GetDetailsViewById) (Return Type : Message) Parameters Count verify

        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_Quote_GetDetailsViewById_Method_Call_Parameters_Count_Verification_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodGetDetailsViewById);
            var currentMethodInfo = this.GetMethodInfo(MethodGetDetailsViewById, 0);
