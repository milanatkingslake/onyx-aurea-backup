...
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="OnyxQASIntegration.Program" />)
    ...
    public class ProgramTest : AbstractBaseSetupV3Test
    {
        ...
        /// </summary>
        public ProgramTest() : base(publicType: typeof(SearchAddress), classNameWithNamespace: ProgramNonPublicTypeName)
        { }
        ...
        private const string ProgramNonPublicTypeName = "OnyxQASIntegration.Program";
