...
namespace Avolin.Onyx.Part15.AUT.Tests.Onyx.OEASService
{
    ...
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="Onyx.OEASService.LogHelper" />)
    ...
    {
        /// <summary>
        ///     Automatic Unit Tests for a public class (<see cref="LogHelper" />)
        /// </summary>
        public LogHelperTest() : base(typeof(LogHelper))
        { }
        ...
        private LogHelper _logHelperInstance;
        private LogHelper _logHelperInstanceFixture;
        ...
        {
            _logHelperInstanceType = typeof(LogHelper);
            _logHelperInstanceFixture = this.Create<LogHelper>(false);
            _logHelperInstance = _logHelperInstanceFixture ?? this.Create<LogHelper>(true);
        ...
        [TestCase(MethodDebug, 1)]
        [TestCase(MethodError, 0)]
        [TestCase(MethodError, 1)]
        ...
        #region General Instance : Class (LogHelper) Static Class or Instance Creation

        /// <summary>
        ///     Class (<see cref="LogHelper" />) can be created test
        /// </summary>
        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT Instance")]
        public void AUT_LogHelper_Is_Instance_Present_Test()
        {
            // Assert
            _logHelperInstanceType.ShouldNotBeNull();
            _logHelperInstance.ShouldNotBeNull();
            _logHelperInstanceFixture.ShouldNotBeNull();
            CurrentInstance.ShouldNotBeNull();
        }

        #endregion

        #region General Instance : Class (LogHelper) Instance Type Verify Test

        /// <summary>
        ///     Class (<see cref="LogHelper" />) instance type verify test.
        /// </summary>
        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT Instance")]
        public void AUT_LogHelper_Is_Instance_Type_Verify_Test()
        {
            // Assert
            _logHelperInstance.ShouldBeAssignableTo<LogHelper>();
            _logHelperInstanceFixture.ShouldBeAssignableTo<LogHelper>();
            CurrentInstance.ShouldBeAssignableTo<LogHelper>();
        }
        ...
        #region General Constructor : Class (LogHelper) with Parameter Test

        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT Constructor")]
        public void AUT_LogHelper_Constructor_With_Parameter_Created_Instance_Type_Test()
        {
            // Arrange
            var logClass = this.CreateType<Type>();
            LogHelper instance = null;
            Exception creationException = null;

            // Act
            Action createAction = () => instance = new LogHelper(logClass);
            ...
            _logHelperInstance.ShouldNotBeNull();
            _logHelperInstanceFixture.ShouldNotBeNull();
            instance.ShouldBeOfType<LogHelper>();
        }
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT Constructor")]
        public void AUT_LogHelper_Constructor_Instantiation_With_Parameter_Test()
        {
            // Arrange
            var logClass = this.CreateType<Type>();
            LogHelper instance = null;
        ...
        #region Method Call : (Debug) (Return Type : void) Direct Call Exception Thrown Test

        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_LogHelper_Debug_Method_DirectCall_Throw_Exception_Test()
        {
            // Arrange
            ...
            // Act
            Action executeAction = () => _logHelperInstance.Debug(message);
        ...
        #region Method Call : (Debug) (Return Type : void) Exception Thrown

        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_LogHelper_Debug_Method_Call_Void_With_No_Parameters_Call_Throw_Exception_Thrown_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodDebug);
            var message = this.CreateType<string>();
            ...
            // Act
            Action currentAction = () => currentMethodInfo.Invoke(_logHelperInstanceFixture, parametersOfDebug);
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_LogHelper_Debug_Method_Call_Void_With_No_Parameters_Call_No_Exception_Thrown_With_Encapsulation_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodDebug);
            var message = this.CreateType<string>();
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_LogHelper_Debug_Method_Call_Parameters_Count_Verification_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodDebug);
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_LogHelper_Debug_Method_Call_Dynamic_Invoking_Should_Not_Throw_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodDebug);
            var methodDebugParametersTypes = new Type[] { typeof(string) };
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_LogHelper_Debug_Method_Call_With_Dynamic_Invoking_Without_Parameters_Should_Not_Throw_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodDebug);
            var currentMethodInfo = this.GetMethodInfo(MethodDebug, 0);
        ...
        [ExcludeFromCodeCoverage]
        private void AUT_LogHelper_Debug_Method_Overloading_Of_1_Call_Internally(Type[] types)
        {
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_LogHelper_Debug_Method_DirectCall_Overloading_Of_1_Throw_Exception_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodDebug);
            var message = this.CreateType<string>();
            var onyxContextData = this.CreateType<OnyxContextData>();

            // Act
            Action executeAction = () => _logHelperInstance.Debug(message, onyxContextData);
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_LogHelper_Debug_Method_Call_Void_Overloading_Of_1_With_No_Parameters_Call_Throw_Exception_Thrown_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodDebug);
            var message = this.CreateType<string>();
            var onyxContextData = this.CreateType<OnyxContextData>();
            var methodDebugParametersTypes = new Type[] { typeof(string), typeof(OnyxContextData) };
            object[] parametersOfDebug = { message, onyxContextData };
            Exception exception = null;
            var currentMethodInfo = this.GetMethodInfo(MethodDebug, methodDebugParametersTypes, out exception);
            ...
            exception.ShouldBeNull();
            parametersOfDebug.ShouldNotBeNull();
            parametersOfDebug.Length.ShouldBe(2);
            methodDebugParametersTypes.Length.ShouldBe(2);
            methodDebugParametersTypes.Length.ShouldBe(parametersOfDebug.Length);
            Should.Throw<Exception>(currentAction);
        }
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_LogHelper_Debug_Method_Call_Void_Overloading_Of_1_With_No_Parameters_Call_No_Exception_Thrown_With_Encapsulation_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodDebug);
            var message = this.CreateType<string>();
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_LogHelper_Debug_Method_Call_Overloading_Of_1_Parameters_Count_Verification_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodDebug);
            var currentMethodInfo = this.GetMethodInfo(MethodDebug, 1);
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_LogHelper_Debug_Method_Call_Overloading_Of_1_Dynamic_Invoking_Should_Not_Throw_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodDebug);
            var methodDebugParametersTypes = new Type[] { typeof(string), typeof(OnyxContextData) };
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_LogHelper_Debug_Method_Call_Overloading_Of_1_With_Dynamic_Invoking_Without_Parameters_Should_Not_Throw_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodDebug);
            var currentMethodInfo = this.GetMethodInfo(MethodDebug, 1);
        ...
        [ExcludeFromCodeCoverage]
        private void AUT_LogHelper_Error_Method_Call_Internally(Type[] types)
        {
        ...
        #region Method Call : (Error) (Return Type : void) Direct Call Exception Thrown Test

        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_LogHelper_Error_Method_DirectCall_Throw_Exception_Test()
        {
            // Arrange
            ...
            // Act
            Action executeAction = () => _logHelperInstance.Error(message, ex);
        ...
        #region Method Call : (Error) (Return Type : void) Exception Thrown

        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_LogHelper_Error_Method_Call_Void_With_No_Parameters_Call_Throw_Exception_Thrown_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodError);
            var message = this.CreateType<string>();
            ...
            object[] parametersOfError = { message, ex };
            Exception exception = null;
            var currentMethodInfo = this.GetMethodInfo(MethodError, methodErrorParametersTypes, out exception);

            // Act
            Action currentAction = () => currentMethodInfo.Invoke(_logHelperInstanceFixture, parametersOfError);
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_LogHelper_Error_Method_Call_Void_With_No_Parameters_Call_No_Exception_Thrown_With_Encapsulation_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodError);
            var message = this.CreateType<string>();
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_LogHelper_Error_Method_Call_Parameters_Count_Verification_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodError);
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_LogHelper_Error_Method_Call_Dynamic_Invoking_Should_Not_Throw_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodError);
            var methodErrorParametersTypes = new Type[] { typeof(string), typeof(Exception) };
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_LogHelper_Error_Method_Call_With_Dynamic_Invoking_Without_Parameters_Should_Not_Throw_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodError);
            var currentMethodInfo = this.GetMethodInfo(MethodError, 0);
        ...
        [ExcludeFromCodeCoverage]
        private void AUT_LogHelper_Error_Method_Overloading_Of_1_Call_Internally(Type[] types)
        {
            var methodErrorParametersTypes = types;
            this.InvokeMethodDynamicallyWithType(MethodError, methodErrorParametersTypes);
        }
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_LogHelper_Error_Method_DirectCall_Overloading_Of_1_Throw_Exception_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodError);
            var message = this.CreateType<string>();
            ...
            // Act
            Action executeAction = () => _logHelperInstance.Error(message, ex, onyxContextData);
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_LogHelper_Error_Method_Call_Void_Overloading_Of_1_With_No_Parameters_Call_Throw_Exception_Thrown_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodError);
            var message = this.CreateType<string>();
            var ex = this.CreateType<Exception>();
            var onyxContextData = this.CreateType<OnyxContextData>();
            var methodErrorParametersTypes = new Type[] { typeof(string), typeof(Exception), typeof(OnyxContextData) };
            object[] parametersOfError = { message, ex, onyxContextData };
            Exception exception = null;
            var currentMethodInfo = this.GetMethodInfo(MethodError, methodErrorParametersTypes, out exception);
            ...
            exception.ShouldBeNull();
            parametersOfError.ShouldNotBeNull();
            parametersOfError.Length.ShouldBe(3);
            methodErrorParametersTypes.Length.ShouldBe(3);
            methodErrorParametersTypes.Length.ShouldBe(parametersOfError.Length);
            Should.Throw<Exception>(currentAction);
        }
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_LogHelper_Error_Method_Call_Void_Overloading_Of_1_With_No_Parameters_Call_No_Exception_Thrown_With_Encapsulation_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodError);
            var message = this.CreateType<string>();
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_LogHelper_Error_Method_Call_Overloading_Of_1_Parameters_Count_Verification_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodError);
            var currentMethodInfo = this.GetMethodInfo(MethodError, 1);
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_LogHelper_Error_Method_Call_Overloading_Of_1_Dynamic_Invoking_Should_Not_Throw_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodError);
            var methodErrorParametersTypes = new Type[] { typeof(string), typeof(Exception), typeof(OnyxContextData) };
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_LogHelper_Error_Method_Call_Overloading_Of_1_With_Dynamic_Invoking_Without_Parameters_Should_Not_Throw_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodError);
            var currentMethodInfo = this.GetMethodInfo(MethodError, 1);
        ...
        [ExcludeFromCodeCoverage]
        private void AUT_LogHelper_Fatal_Method_Call_Internally(Type[] types)
        {
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_LogHelper_Fatal_Method_DirectCall_No_Exception_Thrown_Test()
        {
            // Arrange
            ...
            // Act
            Action executeAction = () => _logHelperInstance.Fatal(message);
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_LogHelper_Fatal_Method_Call_Void_With_No_Parameters_No_Exception_Thrown_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodFatal);
            var message = this.CreateType<string>();
            var methodFatalParametersTypes = new Type[] { typeof(string) };
            object[] parametersOfFatal = { message };
            Exception exception = null;
            var currentMethodInfo = this.GetMethodInfo(MethodFatal, methodFatalParametersTypes, out exception);

            // Act
            Action currentAction = () => currentMethodInfo.Invoke(_logHelperInstanceFixture, parametersOfFatal);
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_LogHelper_Fatal_Method_Call_Void_With_No_Parameters_Call_No_Exception_Thrown_With_Encapsulation_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodFatal);
            var message = this.CreateType<string>();
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_LogHelper_Fatal_Method_Call_Parameters_Count_Verification_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodFatal);
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_LogHelper_Fatal_Method_Call_Dynamic_Invoking_Should_Not_Throw_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodFatal);
            var methodFatalParametersTypes = new Type[] { typeof(string) };
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_LogHelper_Fatal_Method_Call_With_Dynamic_Invoking_Without_Parameters_Should_Not_Throw_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodFatal);
            var currentMethodInfo = this.GetMethodInfo(MethodFatal, 0);
        ...
        [ExcludeFromCodeCoverage]
        private void AUT_LogHelper_Info_Method_Call_Internally(Type[] types)
        {
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_LogHelper_Info_Method_DirectCall_No_Exception_Thrown_Test()
        {
            // Arrange
            ...
            // Act
            Action executeAction = () => _logHelperInstance.Info(message);
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_LogHelper_Info_Method_Call_Void_With_No_Parameters_No_Exception_Thrown_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodInfo);
            var message = this.CreateType<string>();
            ...
            // Act
            Action currentAction = () => currentMethodInfo.Invoke(_logHelperInstanceFixture, parametersOfInfo);
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_LogHelper_Info_Method_Call_Void_With_No_Parameters_Call_No_Exception_Thrown_With_Encapsulation_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodInfo);
            var message = this.CreateType<string>();
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_LogHelper_Info_Method_Call_Parameters_Count_Verification_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodInfo);
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_LogHelper_Info_Method_Call_Dynamic_Invoking_Should_Not_Throw_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodInfo);
            var methodInfoParametersTypes = new Type[] { typeof(string) };
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_LogHelper_Info_Method_Call_With_Dynamic_Invoking_Without_Parameters_Should_Not_Throw_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodInfo);
            var currentMethodInfo = this.GetMethodInfo(MethodInfo, 0);
        ...
        [ExcludeFromCodeCoverage]
        private void AUT_LogHelper_Warn_Method_Call_Internally(Type[] types)
        {
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_LogHelper_Warn_Method_DirectCall_No_Exception_Thrown_Test()
        {
            // Arrange
            ...
            // Act
            Action executeAction = () => _logHelperInstance.Warn(message);
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_LogHelper_Warn_Method_Call_Void_With_No_Parameters_No_Exception_Thrown_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodWarn);
            var message = this.CreateType<string>();
            ...
            // Act
            Action currentAction = () => currentMethodInfo.Invoke(_logHelperInstanceFixture, parametersOfWarn);
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_LogHelper_Warn_Method_Call_Void_With_No_Parameters_Call_No_Exception_Thrown_With_Encapsulation_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodWarn);
            var message = this.CreateType<string>();
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_LogHelper_Warn_Method_Call_Parameters_Count_Verification_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodWarn);
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_LogHelper_Warn_Method_Call_Dynamic_Invoking_Should_Not_Throw_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodWarn);
            var methodWarnParametersTypes = new Type[] { typeof(string) };
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_LogHelper_Warn_Method_Call_With_Dynamic_Invoking_Without_Parameters_Should_Not_Throw_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodWarn);
            var currentMethodInfo = this.GetMethodInfo(MethodWarn, 0);
