...
namespace Avolin.Onyx.Part03.AUT.Tests.OnyxISAPI.Persistence
{
    ...
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="OnyxISAPI.Persistence.ResultGridToolActionItem" />)
    ///     and namespace <see cref="OnyxISAPI.Persistence"/> class using generator(v:0.2.5)'s
    ///     artificial intelligence. Compatible with <see cref="AUT.TestProjects.GenV3" /> v1.2+.
    /// </summary>
    [TestFixture]
    [ExcludeFromCodeCoverage]
    public partial class ResultGridToolActionItemTest : AbstractBaseSetupV3Test
    {
        /// <summary>
        ...
        #region General Getters/Setters : Class (ResultGridToolActionItem) => Property (Id) (Can Read) tests

        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT GetterSetter")]
        public void AUT_ResultGridToolActionItem_Public_Class_Id_Coverage_For_Property_Is_Present_And_Can_Read_Test()
        {
            // Arrange
        ...
        #region General Getters/Setters : Class (ResultGridToolActionItem) => Property (Name) (Can Read) tests

        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT GetterSetter")]
        public void AUT_ResultGridToolActionItem_Public_Class_Name_Coverage_For_Property_Is_Present_And_Can_Read_Test()
        {
            // Arrange
        ...
        #region General Getters/Setters : Class (ResultGridToolActionItem) => Property (RecordStatus) (Can Read) tests

        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT GetterSetter")]
        public void AUT_ResultGridToolActionItem_Public_Class_RecordStatus_Coverage_For_Property_Is_Present_And_Can_Read_Test()
        {
            // Arrange
        ...
        #region General Getters/Setters : Class (ResultGridToolActionItem) => Property (ResultGridToolActionGroup) Property Type Test Except String

        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT GetterSetter")]
        public void AUT_ResultGridToolActionItem_ResultGridToolActionGroup_Property_Setting_String_Throw_Argument_Exception_Test()
        {
            // Arrange
            ...
            Action currentAction = () => propertyInfo.SetValue(_resultGridToolActionItemInstance, randomString, null);
        ...
        #region General Getters/Setters : Class (ResultGridToolActionItem) => Property (ResultGridToolActionGroup) (Can Read) tests

        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT GetterSetter")]
        public void AUT_ResultGridToolActionItem_Public_Class_ResultGridToolActionGroup_Coverage_For_Property_Is_Present_And_Can_Read_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(PropertyResultGridToolActionGroup);
            var propertyInfo = this.GetPropertyInfo(PropertyResultGridToolActionGroup);
        ...
        #region General Getters/Setters : Class (ResultGridToolActionItem) => Property (SequenceIndex) (Can Read) tests

        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT GetterSetter")]
        public void AUT_ResultGridToolActionItem_Public_Class_SequenceIndex_Coverage_For_Property_Is_Present_And_Can_Read_Test()
        {
            // Arrange
        ...
        #region General Getters/Setters : Class (ResultGridToolActionItem) => Property (SiteId) (Can Read) tests

        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT GetterSetter")]
        public void AUT_ResultGridToolActionItem_Public_Class_SiteId_Coverage_For_Property_Is_Present_And_Can_Read_Test()
        {
            // Arrange
