...
namespace Avolin.Onyx.Part03.AUT.Tests.OnyxISAPI.Persistence
{
    ...
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="OnyxISAPI.Persistence.ResultGridToolActionGroup" />)
    ///     and namespace <see cref="OnyxISAPI.Persistence"/> class using generator(v:0.2.5)'s
    ///     artificial intelligence. Compatible with <see cref="AUT.TestProjects.GenV3" /> v1.2+.
    /// </summary>
    [TestFixture]
    [ExcludeFromCodeCoverage]
    public partial class ResultGridToolActionGroupTest : AbstractBaseSetupV3Test
    {
        /// <summary>
        ...
        #region General Getters/Setters : Class (ResultGridToolActionGroup) => Property (Name) (Can Read) tests

        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT GetterSetter")]
        public void AUT_ResultGridToolActionGroup_Public_Class_Name_Coverage_For_Property_Is_Present_And_Can_Read_Test()
        {
            // Arrange
        ...
        #region General Getters/Setters : Class (ResultGridToolActionGroup) => Property (RecordStatus) (Can Read) tests

        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT GetterSetter")]
        public void AUT_ResultGridToolActionGroup_Public_Class_RecordStatus_Coverage_For_Property_Is_Present_And_Can_Read_Test()
        {
            // Arrange
        ...
        #region General Getters/Setters : Class (ResultGridToolActionGroup) => Property (ResultGridToolActionItem) (Can Read) tests

        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT GetterSetter")]
        public void AUT_ResultGridToolActionGroup_Public_Class_ResultGridToolActionItem_Coverage_For_Property_Is_Present_And_Can_Read_Test()
        {
            // Arrange
        ...
        #region General Getters/Setters : Class (ResultGridToolActionGroup) => Property (SequenceIndex) (Can Read) tests

        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT GetterSetter")]
        public void AUT_ResultGridToolActionGroup_Public_Class_SequenceIndex_Coverage_For_Property_Is_Present_And_Can_Read_Test()
        {
            // Arrange
        ...
        #region General Getters/Setters : Class (ResultGridToolActionGroup) => Property (SiteId) (Can Read) tests

        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT GetterSetter")]
        public void AUT_ResultGridToolActionGroup_Public_Class_SiteId_Coverage_For_Property_Is_Present_And_Can_Read_Test()
        {
            // Arrange
