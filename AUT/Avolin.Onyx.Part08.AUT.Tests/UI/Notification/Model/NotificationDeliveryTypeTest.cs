...
namespace Avolin.Onyx.Part08.AUT.Tests.UI.Notification.Model
{
    ...
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="Onyx.UI.Notification.Model.NotificationDeliveryType" />)
    ///     and namespace <see cref="Onyx.UI.Notification.Model"/> class using generator(v:0.2.5)'s
    ///     artificial intelligence. Compatible with <see cref="AUT.TestProjects.GenV3" /> v1.2+.
    /// </summary>
    [TestFixture]
    [ExcludeFromCodeCoverage]
    public class NotificationDeliveryTypeTest : AbstractBaseSetupV3Test
    {
        /// <summary>
        ...
        #region General Getters/Setters : Class (NotificationDeliveryType) => Property (DeliveryDescription) (Can Read) tests

        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT GetterSetter")]
        public void AUT_NotificationDeliveryType_Public_Class_DeliveryDescription_Coverage_For_Property_Is_Present_And_Can_Read_Test()
        {
            // Arrange
        ...
        #region General Getters/Setters : Class (NotificationDeliveryType) => Property (NotificationDeliveryTypeName) (Can Read) tests

        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT GetterSetter")]
        public void AUT_NotificationDeliveryType_Public_Class_NotificationDeliveryTypeName_Coverage_For_Property_Is_Present_And_Can_Read_Test()
        {
            // Arrange
