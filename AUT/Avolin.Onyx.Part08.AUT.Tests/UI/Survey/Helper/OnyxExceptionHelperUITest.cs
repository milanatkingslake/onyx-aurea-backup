...
using Onyx.UI.Survey.Helper;
using Onyx.UI.Survey.Model;
using OnyxSDK.Public.OnyxException;
using Shouldly;

namespace Avolin.Onyx.Part08.AUT.Tests.UI.Survey.Helper
{
    using Action = System.Action;
    using Should = Shouldly.Should;

    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="Onyx.UI.Survey.Helper.OnyxExceptionHelperUI" />)
    ///     and namespace <see cref="Onyx.UI.Survey.Helper"/> class using generator(v:0.2.5)'s
