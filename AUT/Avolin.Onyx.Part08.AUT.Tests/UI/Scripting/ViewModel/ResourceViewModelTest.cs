...
namespace Avolin.Onyx.Part08.AUT.Tests.UI.Scripting.ViewModel
{
    using Action = System.Action;
    using Should = Shouldly.Should;

    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="Onyx.UI.Scripting.ViewModel.ResourceViewModel" />)
    ///     and namespace <see cref="Onyx.UI.Scripting.ViewModel"/> class using generator(v:0.2.5)'s
    ...
    public class ResourceViewModelTest : AbstractBaseSetupV3Test
    {
        ...
        #region General Getters/Setters : Class (ResourceViewModel) => Property (Key) (Can Read) tests

        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT GetterSetter")]
        public void AUT_ResourceViewModel_Public_Class_Key_Coverage_For_Property_Is_Present_And_Can_Read_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(PropertyKey);
            var propertyInfo = this.GetPropertyInfo(PropertyKey);
