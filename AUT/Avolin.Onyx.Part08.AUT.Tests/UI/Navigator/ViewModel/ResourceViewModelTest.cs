...
namespace Avolin.Onyx.Part08.AUT.Tests.UI.Navigator.ViewModel
{
    using Action = System.Action;
    using Should = Shouldly.Should;

    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="Onyx.UI.Navigator.ViewModel.ResourceViewModel" />)
    ///     and namespace <see cref="Onyx.UI.Navigator.ViewModel"/> class using generator(v:0.2.5)'s
