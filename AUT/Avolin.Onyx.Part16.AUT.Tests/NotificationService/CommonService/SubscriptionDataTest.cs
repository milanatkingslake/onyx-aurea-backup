...
namespace Avolin.Onyx.Part16.AUT.Tests.NotificationService.CommonService
{
    ...
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="NotificationService.CommonService.SubscriptionData" />)
    ...
    public class SubscriptionDataTest : AbstractBaseSetupV3Test
    {
        ...
        private const string PropertyDeliveryType = "DeliveryType";
        ...
        #region General Getters/Setters : Class (SubscriptionData) => Property (DeliveryType) (Can Read) tests

        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT GetterSetter")]
        public void AUT_SubscriptionData_Public_Class_DeliveryType_Coverage_For_Property_Is_Present_And_Can_Read_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(PropertyDeliveryType);
            var propertyInfo = this.GetPropertyInfo(PropertyDeliveryType);
        ...
        #region General Getters/Setters : Class (SubscriptionData) => Property (SubscriptionID) Property Type Test Except String

        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT GetterSetter")]
        public void AUT_SubscriptionData_SubscriptionID_Property_Setting_String_Throw_Argument_Exception_Test()
        {
            // Arrange
        ...
        #region General Getters/Setters : Class (SubscriptionData) => Property (SubscriptionID) (Can Read) tests

        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT GetterSetter")]
        public void AUT_SubscriptionData_Public_Class_SubscriptionID_Coverage_For_Property_Is_Present_And_Can_Read_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(PropertySubscriptionID);
            var propertyInfo = this.GetPropertyInfo(PropertySubscriptionID);
        ...
        #region General Getters/Setters : Class (SubscriptionData) => Property (User) Property Type Test Except String

        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT GetterSetter")]
        public void AUT_SubscriptionData_User_Property_Setting_String_Throw_Argument_Exception_Test()
        {
            // Arrange
        ...
        #region General Getters/Setters : Class (SubscriptionData) => Property (User) (Can Read) tests

        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT GetterSetter")]
        public void AUT_SubscriptionData_Public_Class_User_Coverage_For_Property_Is_Present_And_Can_Read_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(PropertyUser);
            var propertyInfo = this.GetPropertyInfo(PropertyUser);
