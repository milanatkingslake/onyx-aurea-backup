...
namespace Avolin.Onyx.Part16.AUT.Tests.NotificationService.CommonService
{
    ...
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="NotificationService.CommonService.ContextData" />)
    ///     and namespace <see cref="NotificationService.CommonService"/> class using generator(v:0.2.5)'s
    ///     artificial intelligence. Compatible with <see cref="AUT.TestProjects.GenV3" /> v1.2+.
    /// </summary>
    [TestFixture]
    [ExcludeFromCodeCoverage]
    public class ContextDataTest : AbstractBaseSetupV3Test
    {
        /// <summary>
