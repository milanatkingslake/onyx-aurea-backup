...
namespace NotificationService.WindowsService
{
    ...
    public partial class NotificationWindowsServiceInstallerTest : AbstractBaseSetupV3Test
    {
        /// <summary>
        ///     Automatic Unit Tests for a public class (<see cref="NotificationWindowsServiceInstaller" />)
        /// </summary>
        public NotificationWindowsServiceInstallerTest() : base(typeof(NotificationWindowsServiceInstaller))
        { }
        ...
        private NotificationWindowsServiceInstaller _notificationWindowsServiceInstallerInstance;
        private NotificationWindowsServiceInstaller _notificationWindowsServiceInstallerInstanceFixture;
        ...
        {
            _notificationWindowsServiceInstallerInstanceType = typeof(NotificationWindowsServiceInstaller);
            _notificationWindowsServiceInstallerInstanceFixture = this.Create<NotificationWindowsServiceInstaller>(false);
            _notificationWindowsServiceInstallerInstance = _notificationWindowsServiceInstallerInstanceFixture ?? this.Create<NotificationWindowsServiceInstaller>(true);
        ...
        public void AUT_NotificationWindowsServiceInstaller_Explore_Reflection_Based_NonListed_Methods_Test()
        {
            // Arrange
        ...
        [NUnit.Framework.Category("AUT Slow Tests")]
        [NUnit.Framework.Category("AUT Explore")]
        public void AUT_NotificationWindowsServiceInstaller_Explore_Reflection_Based_NonListed_Properties_Test()
        {
            // Arrange
        ...
        [NUnit.Framework.Category("AUT Slow Tests")]
        [NUnit.Framework.Category("AUT Explore")]
        public void AUT_NotificationWindowsServiceInstaller_Explore_Reflection_Based_NonListed_Fields_Test()
        {
            // Arrange
        ...
        #region General Initializer : Class (NotificationWindowsServiceInstaller) All Methods Explore Verification.
        ...
        public void AUT_NotificationWindowsServiceInstaller_All_Methods_Explore_Verify_Test(string name, int overloadingIndex = 0)
        {
            // Arrange
        ...
        #region General Initializer : Class (NotificationWindowsServiceInstaller) All Properties Explore By Name

        /// <summary>
        ///     Class (<see cref="NotificationWindowsServiceInstaller" />) explore and verify properties for coverage gain.
        /// </summary>
        [Test]
        [Timeout(TestsTimeOut)]
        [NUnit.Framework.Category("AUT Initializer")]
        ...
        public void AUT_NotificationWindowsServiceInstaller_All_Properties_Explore_Verify_By_Name_Test(string name)
        {
            // Arrange
            this.ValidateExecuteCondition(name);
        ...
        public void AUT_NotificationWindowsServiceInstaller_All_Fields_Explore_Verify_By_Name_Test(string name)
        {
            // Arrange
            this.ValidateExecuteCondition(name);
        ...
        #region General Instance : Class (NotificationWindowsServiceInstaller) Static Class or Instance Creation

        /// <summary>
        ///     Class (<see cref="NotificationWindowsServiceInstaller" />) can be created test
        /// </summary>
        [Test]
        [Timeout(TestsTimeOut)]
        [NUnit.Framework.Category("AUT Instance")]
        public void AUT_NotificationWindowsServiceInstaller_Is_Instance_Present_Test()
        {
            // Assert
            _notificationWindowsServiceInstallerInstanceType.ShouldNotBeNull();
            _notificationWindowsServiceInstallerInstance.ShouldNotBeNull();
            _notificationWindowsServiceInstallerInstanceFixture.ShouldNotBeNull();
            CurrentInstance.ShouldNotBeNull();
        }

        #endregion

        #region General Instance : Class (NotificationWindowsServiceInstaller) Instance Type Verify Test

        /// <summary>
        ///     Class (<see cref="NotificationWindowsServiceInstaller" />) instance type verify test.
        /// </summary>
        [Test]
        [Timeout(TestsTimeOut)]
        [NUnit.Framework.Category("AUT Instance")]
        public void AUT_NotificationWindowsServiceInstaller_Is_Instance_Type_Verify_Test()
        {
            // Assert
            _notificationWindowsServiceInstallerInstance.ShouldBeAssignableTo<NotificationWindowsServiceInstaller>();
            _notificationWindowsServiceInstallerInstanceFixture.ShouldBeAssignableTo<NotificationWindowsServiceInstaller>();
            CurrentInstance.ShouldBeAssignableTo<NotificationWindowsServiceInstaller>();
        }
        ...
        #region General Getters/Setters : Class (NotificationWindowsServiceInstaller) => all properties explore by setting value.
        ...
        [TestCase(PropertyServiceUsername)]
        [TestCase(PropertyServicePassword)]
        public void AUT_NotificationWindowsServiceInstaller_Property_Exist_By_Name_Verify_Test(string name)
        {
            // Arrange
            this.ValidateExecuteCondition(name);
            var propertyInfo = this.GetPropertyInfo(name);
        ...
        #region General Getters/Setters : Class (NotificationWindowsServiceInstaller) => Property (Account) Property Type Test Except String

        [Test]
        [Timeout(TestsTimeOut)]
        [NUnit.Framework.Category("AUT GetterSetter")]
        public void AUT_NotificationWindowsServiceInstaller_Account_Property_Setting_String_Throw_Argument_Exception_Test()
        {
            // Arrange
            ...
            Action currentAction = () => propertyInfo.SetValue(_notificationWindowsServiceInstallerInstance, randomString, null);
        ...
        #region General Getters/Setters : Class (NotificationWindowsServiceInstaller) => Property (Account) (Can Read) tests

        [Test]
        [Timeout(TestsTimeOut)]
        [NUnit.Framework.Category("AUT GetterSetter")]
        public void AUT_NotificationWindowsServiceInstaller_Public_Class_Account_Coverage_For_Property_Is_Present_And_Can_Read_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(PropertyAccount);
            var propertyInfo = this.GetPropertyInfo(PropertyAccount);
        ...
        #region General Getters/Setters : Class (NotificationWindowsServiceInstaller) => Property (Description) (Can Read) tests

        [Test]
        [Timeout(TestsTimeOut)]
        [NUnit.Framework.Category("AUT GetterSetter")]
        public void AUT_NotificationWindowsServiceInstaller_Public_Class_Description_Coverage_For_Property_Is_Present_And_Can_Read_Test()
        {
            // Arrange
        ...
        #region General Getters/Setters : Class (NotificationWindowsServiceInstaller) => Property (DisplayName) (Can Read) tests

        [Test]
        [Timeout(TestsTimeOut)]
        [NUnit.Framework.Category("AUT GetterSetter")]
        public void AUT_NotificationWindowsServiceInstaller_Public_Class_DisplayName_Coverage_For_Property_Is_Present_And_Can_Read_Test()
        {
            // Arrange
        ...
        #region General Getters/Setters : Class (NotificationWindowsServiceInstaller) => Property (ServiceName) (Can Read) tests

        [Test]
        [Timeout(TestsTimeOut)]
        [NUnit.Framework.Category("AUT GetterSetter")]
        public void AUT_NotificationWindowsServiceInstaller_Public_Class_ServiceName_Coverage_For_Property_Is_Present_And_Can_Read_Test()
        {
            // Arrange
        ...
        #region General Getters/Setters : Class (NotificationWindowsServiceInstaller) => Property (ServicePassword) (Can Read) tests

        [Test]
        [Timeout(TestsTimeOut)]
        [NUnit.Framework.Category("AUT GetterSetter")]
        public void AUT_NotificationWindowsServiceInstaller_Public_Class_ServicePassword_Coverage_For_Property_Is_Present_And_Can_Read_Test()
        {
            // Arrange
        ...
        #region General Getters/Setters : Class (NotificationWindowsServiceInstaller) => Property (ServiceUsername) (Can Read) tests

        [Test]
        [Timeout(TestsTimeOut)]
        [NUnit.Framework.Category("AUT GetterSetter")]
        public void AUT_NotificationWindowsServiceInstaller_Public_Class_ServiceUsername_Coverage_For_Property_Is_Present_And_Can_Read_Test()
        {
            // Arrange
        ...
        #region General Getters/Setters : Class (NotificationWindowsServiceInstaller) => Property (StartType) Property Type Test Except String

        [Test]
        [Timeout(TestsTimeOut)]
        [NUnit.Framework.Category("AUT GetterSetter")]
        public void AUT_NotificationWindowsServiceInstaller_StartType_Property_Setting_String_Throw_Argument_Exception_Test()
        {
            // Arrange
        ...
        #region General Getters/Setters : Class (NotificationWindowsServiceInstaller) => Property (StartType) (Can Read) tests

        [Test]
        [Timeout(TestsTimeOut)]
        [NUnit.Framework.Category("AUT GetterSetter")]
        public void AUT_NotificationWindowsServiceInstaller_Public_Class_StartType_Coverage_For_Property_Is_Present_And_Can_Read_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(PropertyStartType);
            var propertyInfo = this.GetPropertyInfo(PropertyStartType);
        ...
        public void AUT_NotificationWindowsServiceInstaller_ServiceInstaller_Committed_Method_Call_Void_With_No_Parameters_Call_Throw_Exception_Thrown_Test()
        {
            // Arrange
            ...
            // Act
            Action currentAction = () => currentMethodInfo.Invoke(_notificationWindowsServiceInstallerInstanceFixture, parametersOfServiceInstaller_Committed);
        ...
        [Timeout(TestsTimeOut)]
        [NUnit.Framework.Category("AUT MethodCallTest")]
        public void AUT_NotificationWindowsServiceInstaller_ServiceInstaller_Committed_Method_Call_Void_With_No_Parameters_Call_No_Exception_Thrown_With_Encapsulation_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodServiceInstaller_Committed);
            var sender = this.CreateType<object>();
        ...
        [Timeout(TestsTimeOut)]
        [NUnit.Framework.Category("AUT MethodCallTest")]
        public void AUT_NotificationWindowsServiceInstaller_ServiceInstaller_Committed_Method_Call_Parameters_Count_Verification_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodServiceInstaller_Committed);
        ...
        [Timeout(TestsTimeOut)]
        [NUnit.Framework.Category("AUT MethodCallTest")]
        public void AUT_NotificationWindowsServiceInstaller_ServiceInstaller_Committed_Method_Call_Dynamic_Invoking_Should_Not_Throw_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodServiceInstaller_Committed);
            var methodServiceInstaller_CommittedParametersTypes = new Type[] { typeof(object), typeof(InstallEventArgs) };
        ...
        [Timeout(TestsTimeOut)]
        [NUnit.Framework.Category("AUT MethodCallTest")]
        public void AUT_NotificationWindowsServiceInstaller_ServiceInstaller_Committed_Method_Call_With_Dynamic_Invoking_Without_Parameters_Should_Not_Throw_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodServiceInstaller_Committed);
            var currentMethodInfo = this.GetMethodInfo(MethodServiceInstaller_Committed, 0);
        ...
        [ExcludeFromCodeCoverage]
        private void AUT_NotificationWindowsServiceInstaller_GetContextParameter_Method_Call_Internally(Type[] types)
        {
        ...
        [Timeout(TestsTimeOut)]
        [NUnit.Framework.Category("AUT MethodCallTest")]
        public void AUT_NotificationWindowsServiceInstaller_GetContextParameter_Method_DirectCall_No_Exception_Thrown_Test()
        {
            // Arrange
            ...
            // Act
            Action executeAction = () => _notificationWindowsServiceInstallerInstance.GetContextParameter(key);
        ...
        [Timeout(TestsTimeOut)]
        [NUnit.Framework.Category("AUT MethodCallTest")]
        public void AUT_NotificationWindowsServiceInstaller_GetContextParameter_Method_DirectCall_Result_ShouldNotBe_Null_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodGetContextParameter);
            var key = this.CreateType<string>();
            ...
            // Act
            Action executeAction = () => returnedValue = _notificationWindowsServiceInstallerInstance.GetContextParameter(key);
        ...
        [Timeout(TestsTimeOut)]
        [NUnit.Framework.Category("AUT MethodCallTest")]
        public void AUT_NotificationWindowsServiceInstaller_GetContextParameter_Method_Call_With_Results_Should_Not_Be_Null_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodGetContextParameter);
            var key = this.CreateType<string>();
            ...
            // Act
            var result1 = currentMethodInfo.GetResultMethodInfo<string>(_notificationWindowsServiceInstallerInstanceFixture, out exception1, parametersOfGetContextParameter);
        ...
        [Timeout(TestsTimeOut)]
        [NUnit.Framework.Category("AUT MethodCallTest")]
        public void AUT_NotificationWindowsServiceInstaller_GetContextParameter_Method_Call_With_No_Exception_Thrown_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodGetContextParameter);
            var key = this.CreateType<string>();
            ...
            // Act
            Action currentAction = () => currentMethodInfo.Invoke(_notificationWindowsServiceInstallerInstanceFixture, parametersOfGetContextParameter);
        ...
        [Timeout(TestsTimeOut)]
        [NUnit.Framework.Category("AUT MethodCallTest")]
        public void AUT_NotificationWindowsServiceInstaller_GetContextParameter_Method_Call_With_Call_No_Exception_Thrown_With_Encapsulation_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodGetContextParameter);
            var key = this.CreateType<string>();
        ...
        [Timeout(TestsTimeOut)]
        [NUnit.Framework.Category("AUT MethodCallTest")]
        public void AUT_NotificationWindowsServiceInstaller_GetContextParameter_Method_Call_Dynamic_Invoking_Results_Not_Null_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodGetContextParameter);
            var methodGetContextParameterParametersTypes = new Type[] { typeof(string) };
        ...
        [Timeout(TestsTimeOut)]
        [NUnit.Framework.Category("AUT MethodCallTest")]
        public void AUT_NotificationWindowsServiceInstaller_GetContextParameter_Method_Call_Dynamic_Invoking_Should_Not_Throw_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodGetContextParameter);
            var methodGetContextParameterParametersTypes = new Type[] { typeof(string) };
        ...
        [Timeout(TestsTimeOut)]
        [NUnit.Framework.Category("AUT MethodCallTest")]
        public void AUT_NotificationWindowsServiceInstaller_GetContextParameter_Method_Call_Dynamic_Invoking_Results_Should_Not_Be_Null_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodGetContextParameter);
        ...
        [Timeout(TestsTimeOut)]
        [NUnit.Framework.Category("AUT MethodCallTest")]
        public void AUT_NotificationWindowsServiceInstaller_GetContextParameter_Method_Call_Parameters_Count_Verification_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodGetContextParameter);
            var currentMethodInfo = this.GetMethodInfo(MethodGetContextParameter, 0);
        ...
        [ExcludeFromCodeCoverage]
        private void AUT_NotificationWindowsServiceInstaller_OnBeforeInstall_Method_Call_Internally(Type[] types)
        {
        ...
        [Timeout(TestsTimeOut)]
        [NUnit.Framework.Category("AUT MethodCallTest")]
        public void AUT_NotificationWindowsServiceInstaller_OnBeforeInstall_Method_Call_Void_With_No_Parameters_Call_Throw_Exception_Thrown_Test()
        {
            // Arrange
            ...
            // Act
            Action currentAction = () => currentMethodInfo.Invoke(_notificationWindowsServiceInstallerInstanceFixture, parametersOfOnBeforeInstall);
        ...
        [Timeout(TestsTimeOut)]
        [NUnit.Framework.Category("AUT MethodCallTest")]
        public void AUT_NotificationWindowsServiceInstaller_OnBeforeInstall_Method_Call_Void_With_No_Parameters_Call_No_Exception_Thrown_With_Encapsulation_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodOnBeforeInstall);
            var savedState = this.CreateType<IDictionary>();
        ...
        [Timeout(TestsTimeOut)]
        [NUnit.Framework.Category("AUT MethodCallTest")]
        public void AUT_NotificationWindowsServiceInstaller_OnBeforeInstall_Method_Call_Parameters_Count_Verification_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodOnBeforeInstall);
        ...
        [Timeout(TestsTimeOut)]
        [NUnit.Framework.Category("AUT MethodCallTest")]
        public void AUT_NotificationWindowsServiceInstaller_OnBeforeInstall_Method_Call_Dynamic_Invoking_Should_Not_Throw_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodOnBeforeInstall);
            var methodOnBeforeInstallParametersTypes = new Type[] { typeof(IDictionary) };
        ...
        [Timeout(TestsTimeOut)]
        [NUnit.Framework.Category("AUT MethodCallTest")]
        public void AUT_NotificationWindowsServiceInstaller_OnBeforeInstall_Method_Call_With_Dynamic_Invoking_Without_Parameters_Should_Not_Throw_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodOnBeforeInstall);
            var currentMethodInfo = this.GetMethodInfo(MethodOnBeforeInstall, 0);
        ...
        [ExcludeFromCodeCoverage]
        private void AUT_NotificationWindowsServiceInstaller_OnBeforeUninstall_Method_Call_Internally(Type[] types)
        {
        ...
        [Timeout(TestsTimeOut)]
        [NUnit.Framework.Category("AUT MethodCallTest")]
        public void AUT_NotificationWindowsServiceInstaller_OnBeforeUninstall_Method_Call_Void_With_No_Parameters_Call_Throw_Exception_Thrown_Test()
        {
            // Arrange
            ...
            // Act
            Action currentAction = () => currentMethodInfo.Invoke(_notificationWindowsServiceInstallerInstanceFixture, parametersOfOnBeforeUninstall);
        ...
        [Timeout(TestsTimeOut)]
        [NUnit.Framework.Category("AUT MethodCallTest")]
        public void AUT_NotificationWindowsServiceInstaller_OnBeforeUninstall_Method_Call_Void_With_No_Parameters_Call_No_Exception_Thrown_With_Encapsulation_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodOnBeforeUninstall);
            var savedState = this.CreateType<IDictionary>();
        ...
        [Timeout(TestsTimeOut)]
        [NUnit.Framework.Category("AUT MethodCallTest")]
        public void AUT_NotificationWindowsServiceInstaller_OnBeforeUninstall_Method_Call_Parameters_Count_Verification_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodOnBeforeUninstall);
        ...
        [Timeout(TestsTimeOut)]
        [NUnit.Framework.Category("AUT MethodCallTest")]
        public void AUT_NotificationWindowsServiceInstaller_OnBeforeUninstall_Method_Call_Dynamic_Invoking_Should_Not_Throw_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodOnBeforeUninstall);
            var methodOnBeforeUninstallParametersTypes = new Type[] { typeof(IDictionary) };
        ...
        [Timeout(TestsTimeOut)]
        [NUnit.Framework.Category("AUT MethodCallTest")]
        public void AUT_NotificationWindowsServiceInstaller_OnBeforeUninstall_Method_Call_With_Dynamic_Invoking_Without_Parameters_Should_Not_Throw_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodOnBeforeUninstall);
            var currentMethodInfo = this.GetMethodInfo(MethodOnBeforeUninstall, 0);
