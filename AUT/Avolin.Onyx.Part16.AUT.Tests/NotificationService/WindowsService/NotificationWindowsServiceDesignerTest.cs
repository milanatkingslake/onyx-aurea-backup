...
namespace Avolin.Onyx.Part16.AUT.Tests.NotificationService.WindowsService
{
    ...
    public partial class NotificationWindowsServiceDesignerTest : AbstractBaseSetupV3Test
    {
        /// <summary>
        ...
        /// </summary>
        public NotificationWindowsServiceDesignerTest() : base(publicType: typeof(Constants), classNameWithNamespace: NotificationWindowsServiceNonPublicTypeName)
        { }
        ...
        public void AUT_NotificationWindowsServiceDesigner_All_Methods_Explore_Verify_Test(string name, int overloadingIndex = 0)
        {
            // Arrange
        ...
        [Category("AUT Explore")]
        public void AUT_NotificationWindowsServiceDesigner_Explore_Reflection_Based_NonListed_Methods_Test()
        {
            // Assert
        ...
        [Category("AUT Fields")]
        public void AUT_NotificationWindowsServiceDesigner_All_Fields_Explore_Verify_By_Name_Test(string name)
        {
            // Arrange
            this.ValidateExecuteCondition(name);
        ...
        [Category("AUT Slow Tests")]
        [Category("AUT Explore")]
        public void AUT_NotificationWindowsServiceDesigner_Explore_Reflection_Based_NonListed_Fields_Test()
        {
            // Assert
