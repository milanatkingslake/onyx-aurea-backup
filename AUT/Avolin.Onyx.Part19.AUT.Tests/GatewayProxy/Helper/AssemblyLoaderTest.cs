...
namespace Avolin.Onyx.Part19.AUT.Tests.GatewayProxy.Helper
{
    ...
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="Onyx.GatewayProxy.Helper.AssemblyLoader" />)
    ...
    public class AssemblyLoaderTest : AbstractBaseSetupV3Test
    {
        ...
        #region Method Call : (LoadAssemblyFromSettingsAndGetType) (Return Type : Type) private call definition
