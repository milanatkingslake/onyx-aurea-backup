...
namespace Avolin.Onyx.Part04.AUT.Tests.Onyx.Custom.localhost
{
    ...
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="Onyx.Custom.localhost.GetSubscriptionPropertiesCompletedEventArgs" />)
    ///     and namespace <see cref="Onyx.Custom.localhost"/> class using generator(v:0.2.5)'s
    ///     artificial intelligence. Compatible with <see cref="AUT.TestProjects.GenV3" /> v1.2+.
    /// </summary>
    [TestFixture]
    [ExcludeFromCodeCoverage]
    public partial class GetSubscriptionPropertiesCompletedEventArgsTest : AbstractBaseSetupV3Test
    {
        /// <summary>
        ///     Automatic Unit Tests for a public class (<see cref="GetSubscriptionPropertiesCompletedEventArgs" />)
        /// </summary>
        public GetSubscriptionPropertiesCompletedEventArgsTest() : base(typeof(GetSubscriptionPropertiesCompletedEventArgs))
        { }
        ...
        public override void OneTimeSetup()
        {
            ...
            _getSubscriptionPropertiesCompletedEventArgsInstanceFixture = this.Create<GetSubscriptionPropertiesCompletedEventArgs>(false);
            _getSubscriptionPropertiesCompletedEventArgsInstance = _getSubscriptionPropertiesCompletedEventArgsInstanceFixture ?? this.Create<GetSubscriptionPropertiesCompletedEventArgs>(true);
            CurrentInstance = _getSubscriptionPropertiesCompletedEventArgsInstance;
        ...
        #region General Initializer : Class (GetSubscriptionPropertiesCompletedEventArgs) Explore Non-listed Methods

        /// <summary>
        ///     Class (<see cref="GetSubscriptionPropertiesCompletedEventArgs" />) explore and verify methods for coverage gain which is not listed in the constants.
        /// </summary>
        [Test]
        ...
        public void AUT_GetSubscriptionPropertiesCompletedEventArgs_Explore_Reflection_Based_NonListed_Methods_Test()
        {
            // Arrange
        ...
        #region General Initializer : Class (GetSubscriptionPropertiesCompletedEventArgs) Explore Non-listed Properties

        /// <summary>
        ///     Class (<see cref="GetSubscriptionPropertiesCompletedEventArgs" />) explore and verify properties for coverage gain which is not listed in the constants.
        /// </summary>
        [Test]
        [Timeout(TestContants.TimeOutFortySeconds)]
        [NUnit.Framework.Category("AUT Reflection NonListed")]
        [NUnit.Framework.Category("AUT Slow Tests")]
        [NUnit.Framework.Category("AUT Explore")]
        public void AUT_GetSubscriptionPropertiesCompletedEventArgs_Explore_Reflection_Based_NonListed_Properties_Test()
        {
            // Arrange
        ...
        #region General Initializer : Class (GetSubscriptionPropertiesCompletedEventArgs) Explore Non-listed Fields

        /// <summary>
        ///     Class (<see cref="GetSubscriptionPropertiesCompletedEventArgs" />) explore and verify fields for coverage gain which is not listed in the constants.
        /// </summary>
        [Test]
        [Timeout(TestContants.TimeOutFortySeconds)]
        [NUnit.Framework.Category("AUT Reflection NonListed")]
        [NUnit.Framework.Category("AUT Slow Tests")]
        [NUnit.Framework.Category("AUT Explore")]
        public void AUT_GetSubscriptionPropertiesCompletedEventArgs_Explore_Reflection_Based_NonListed_Fields_Test()
        {
            // Arrange
        ...
        #region General Instance : Class (GetSubscriptionPropertiesCompletedEventArgs) Static Class or Instance Creation

        /// <summary>
        ///     Class (<see cref="GetSubscriptionPropertiesCompletedEventArgs" />) can be created test
        /// </summary>
        [Test]
        [Timeout(TestsTimeOut)]
        [NUnit.Framework.Category("AUT Instance")]
        public void AUT_GetSubscriptionPropertiesCompletedEventArgs_Is_Instance_Present_Test()
        {
            // Assert
            _getSubscriptionPropertiesCompletedEventArgsInstanceType.ShouldNotBeNull();
            _getSubscriptionPropertiesCompletedEventArgsInstance.ShouldNotBeNull();
            _getSubscriptionPropertiesCompletedEventArgsInstanceFixture.ShouldNotBeNull();
            CurrentInstance.ShouldNotBeNull();
        }

        #endregion

        #region General Instance : Class (GetSubscriptionPropertiesCompletedEventArgs) Instance Type Verify Test

        /// <summary>
        ///     Class (<see cref="GetSubscriptionPropertiesCompletedEventArgs" />) instance type verify test.
        /// </summary>
        [Test]
        [Timeout(TestsTimeOut)]
        [NUnit.Framework.Category("AUT Instance")]
        public void AUT_GetSubscriptionPropertiesCompletedEventArgs_Is_Instance_Type_Verify_Test()
        {
            // Assert
            _getSubscriptionPropertiesCompletedEventArgsInstance.ShouldBeAssignableTo<GetSubscriptionPropertiesCompletedEventArgs>();
            _getSubscriptionPropertiesCompletedEventArgsInstanceFixture.ShouldBeAssignableTo<GetSubscriptionPropertiesCompletedEventArgs>();
            CurrentInstance.ShouldBeAssignableTo<GetSubscriptionPropertiesCompletedEventArgs>();
        }
        ...
        #region General Getters/Setters : Class (GetSubscriptionPropertiesCompletedEventArgs) => all properties explore by setting value.
        ...
        [TestCase(PropertyMatchData)]
        [TestCase(PropertyParameters)]
        public void AUT_GetSubscriptionPropertiesCompletedEventArgs_Property_Exist_By_Name_Verify_Test(string name)
        {
            // Arrange
            this.ValidateExecuteCondition(name);
            var propertyInfo = this.GetPropertyInfo(name);
