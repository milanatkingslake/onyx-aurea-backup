...
namespace Avolin.Onyx.Part04.AUT.Tests.Onyx.Custom.localhost
{
    ...
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="Onyx.Custom.localhost.DataSourceDefinition" />)
    ///     and namespace <see cref="Onyx.Custom.localhost"/> class using generator(v:0.2.5)'s
    ///     artificial intelligence. Compatible with <see cref="AUT.TestProjects.GenV3" /> v1.2+.
    /// </summary>
    [TestFixture]
    [ExcludeFromCodeCoverage]
    public partial class DataSourceDefinitionTest : AbstractBaseSetupV3Test
    {
        /// <summary>
        ///     Automatic Unit Tests for a public class (<see cref="DataSourceDefinition" />)
        /// </summary>
        public DataSourceDefinitionTest() : base(typeof(DataSourceDefinition))
        { }
        ...
        public override void OneTimeSetup()
        {
            ...
            _dataSourceDefinitionInstanceFixture = this.Create<DataSourceDefinition>(false);
            _dataSourceDefinitionInstance = _dataSourceDefinitionInstanceFixture ?? this.Create<DataSourceDefinition>(true);
            CurrentInstance = _dataSourceDefinitionInstance;
        ...
        #region General Initializer : Class (DataSourceDefinition) Explore Non-listed Methods

        /// <summary>
        ///     Class (<see cref="DataSourceDefinition" />) explore and verify methods for coverage gain which is not listed in the constants.
        /// </summary>
        [Test]
        ...
        public void AUT_DataSourceDefinition_Explore_Reflection_Based_NonListed_Methods_Test()
        {
            // Arrange
        ...
        #region General Initializer : Class (DataSourceDefinition) Explore Non-listed Properties

        /// <summary>
        ///     Class (<see cref="DataSourceDefinition" />) explore and verify properties for coverage gain which is not listed in the constants.
        /// </summary>
        [Test]
        [Timeout(TestContants.TimeOutFortySeconds)]
        [NUnit.Framework.Category("AUT Reflection NonListed")]
        [NUnit.Framework.Category("AUT Slow Tests")]
        [NUnit.Framework.Category("AUT Explore")]
        public void AUT_DataSourceDefinition_Explore_Reflection_Based_NonListed_Properties_Test()
        {
            // Arrange
        ...
        #region General Initializer : Class (DataSourceDefinition) Explore Non-listed Fields

        /// <summary>
        ///     Class (<see cref="DataSourceDefinition" />) explore and verify fields for coverage gain which is not listed in the constants.
        /// </summary>
        [Test]
        [Timeout(TestContants.TimeOutFortySeconds)]
        [NUnit.Framework.Category("AUT Reflection NonListed")]
        [NUnit.Framework.Category("AUT Slow Tests")]
        [NUnit.Framework.Category("AUT Explore")]
        public void AUT_DataSourceDefinition_Explore_Reflection_Based_NonListed_Fields_Test()
        {
            // Arrange
        ...
        #region General Instance : Class (DataSourceDefinition) Static Class or Instance Creation
        ...
        #region General Instance : Class (DataSourceDefinition) Instance Type Verify Test

        /// <summary>
        ///     Class (<see cref="DataSourceDefinition" />) instance type verify test.
        /// </summary>
        [Test]
        [Timeout(TestsTimeOut)]
        [NUnit.Framework.Category("AUT Instance")]
        public void AUT_DataSourceDefinition_Is_Instance_Type_Verify_Test()
        {
            // Assert
            ...
            CurrentInstance.ShouldBeAssignableTo<DataSourceDefinition>();
        }
        ...
        public void AUT_DataSourceDefinition_Instantiated_Without_Parameter_No_Throw_Exception_Test()
        {
            // Arrange
        ...
        #region General Getters/Setters : Class (DataSourceDefinition) => all properties explore by setting value.
        ...
        [TestCase(PropertyEnabled)]
        [TestCase(PropertyEnabledSpecified)]
        public void AUT_DataSourceDefinition_Property_Exist_By_Name_Verify_Test(string name)
        {
            // Arrange
            this.ValidateExecuteCondition(name);
            var propertyInfo = this.GetPropertyInfo(name);
        ...
        {
            // Arrange
            this.ValidateExecuteCondition(PropertyConnectString);
            var propertyInfo = this.GetPropertyInfo(PropertyConnectString);
        ...
        {
            // Arrange
            this.ValidateExecuteCondition(PropertyCredentialRetrieval);
            var randomString = this.CreateType<string>();

            // Act
            var propertyInfo = this.GetPropertyInfo(PropertyCredentialRetrieval);
        ...
        {
            // Arrange
            this.ValidateExecuteCondition(PropertyEnabledSpecified);
            var propertyInfo = this.GetPropertyInfo(PropertyEnabledSpecified);
        ...
        {
            // Arrange
            this.ValidateExecuteCondition(PropertyImpersonateUser);
            var propertyInfo = this.GetPropertyInfo(PropertyImpersonateUser);
        ...
        {
            // Arrange
            this.ValidateExecuteCondition(PropertyImpersonateUserSpecified);
            var propertyInfo = this.GetPropertyInfo(PropertyImpersonateUserSpecified);
        ...
        {
            // Arrange
            this.ValidateExecuteCondition(PropertyOriginalConnectStringExpressionBased);
            var propertyInfo = this.GetPropertyInfo(PropertyOriginalConnectStringExpressionBased);
        ...
        {
            // Arrange
            this.ValidateExecuteCondition(PropertyUseOriginalConnectString);
            var propertyInfo = this.GetPropertyInfo(PropertyUseOriginalConnectString);
        ...
        {
            // Arrange
            this.ValidateExecuteCondition(PropertyWindowsCredentials);
            var propertyInfo = this.GetPropertyInfo(PropertyWindowsCredentials);
