...
namespace Avolin.Onyx.Part04.AUT.Tests.Onyx.Custom.localhost
{
    ...
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="Onyx.Custom.localhost.MonthlyDOWRecurrence" />)
    ///     and namespace <see cref="Onyx.Custom.localhost"/> class using generator(v:0.2.5)'s
    ///     artificial intelligence. Compatible with <see cref="AUT.TestProjects.GenV3" /> v1.2+.
    /// </summary>
    [TestFixture]
    [ExcludeFromCodeCoverage]
    public partial class MonthlyDOWRecurrenceTest : AbstractBaseSetupV3Test
    {
        /// <summary>
        ///     Automatic Unit Tests for a public class (<see cref="MonthlyDOWRecurrence" />)
        /// </summary>
        public MonthlyDOWRecurrenceTest() : base(typeof(MonthlyDOWRecurrence))
        { }
        ...
        public override void OneTimeSetup()
        {
            ...
            _monthlyDOWRecurrenceInstanceFixture = this.Create<MonthlyDOWRecurrence>(false);
            _monthlyDOWRecurrenceInstance = _monthlyDOWRecurrenceInstanceFixture ?? this.Create<MonthlyDOWRecurrence>(true);
            CurrentInstance = _monthlyDOWRecurrenceInstance;
        ...
        #region General Initializer : Class (MonthlyDOWRecurrence) Explore Non-listed Methods

        /// <summary>
        ///     Class (<see cref="MonthlyDOWRecurrence" />) explore and verify methods for coverage gain which is not listed in the constants.
        /// </summary>
        [Test]
        ...
        public void AUT_MonthlyDOWRecurrence_Explore_Reflection_Based_NonListed_Methods_Test()
        {
            // Arrange
        ...
        #region General Initializer : Class (MonthlyDOWRecurrence) Explore Non-listed Properties

        /// <summary>
        ///     Class (<see cref="MonthlyDOWRecurrence" />) explore and verify properties for coverage gain which is not listed in the constants.
        /// </summary>
        [Test]
        [Timeout(TestContants.TimeOutFortySeconds)]
        [NUnit.Framework.Category("AUT Reflection NonListed")]
        [NUnit.Framework.Category("AUT Slow Tests")]
        [NUnit.Framework.Category("AUT Explore")]
        public void AUT_MonthlyDOWRecurrence_Explore_Reflection_Based_NonListed_Properties_Test()
        {
            // Arrange
        ...
        #region General Initializer : Class (MonthlyDOWRecurrence) Explore Non-listed Fields

        /// <summary>
        ///     Class (<see cref="MonthlyDOWRecurrence" />) explore and verify fields for coverage gain which is not listed in the constants.
        /// </summary>
        [Test]
        [Timeout(TestContants.TimeOutFortySeconds)]
        [NUnit.Framework.Category("AUT Reflection NonListed")]
        [NUnit.Framework.Category("AUT Slow Tests")]
        [NUnit.Framework.Category("AUT Explore")]
        public void AUT_MonthlyDOWRecurrence_Explore_Reflection_Based_NonListed_Fields_Test()
        {
            // Arrange
        ...
        #region General Instance : Class (MonthlyDOWRecurrence) Static Class or Instance Creation
        ...
        #region General Instance : Class (MonthlyDOWRecurrence) Instance Type Verify Test

        /// <summary>
        ///     Class (<see cref="MonthlyDOWRecurrence" />) instance type verify test.
        /// </summary>
        [Test]
        [Timeout(TestsTimeOut)]
        [NUnit.Framework.Category("AUT Instance")]
        public void AUT_MonthlyDOWRecurrence_Is_Instance_Type_Verify_Test()
        {
            // Assert
            ...
            CurrentInstance.ShouldBeAssignableTo<MonthlyDOWRecurrence>();
        }
        ...
        public void AUT_MonthlyDOWRecurrence_Instantiated_Without_Parameter_No_Throw_Exception_Test()
        {
            // Arrange
        ...
        #region General Getters/Setters : Class (MonthlyDOWRecurrence) => all properties explore by setting value.
        ...
        [TestCase(PropertyDaysOfWeek)]
        [TestCase(PropertyMonthsOfYear)]
        public void AUT_MonthlyDOWRecurrence_Property_Exist_By_Name_Verify_Test(string name)
        {
            // Arrange
            this.ValidateExecuteCondition(name);
            var propertyInfo = this.GetPropertyInfo(name);
        ...
        {
            // Arrange
            this.ValidateExecuteCondition(PropertyWhichWeek);
            var randomString = this.CreateType<string>();

            // Act
            var propertyInfo = this.GetPropertyInfo(PropertyWhichWeek);
            Action currentAction = () => propertyInfo.SetValue(_monthlyDOWRecurrenceInstance, randomString, null);
        ...
        {
            // Arrange
            this.ValidateExecuteCondition(PropertyWhichWeekSpecified);
            var propertyInfo = this.GetPropertyInfo(PropertyWhichWeekSpecified);
