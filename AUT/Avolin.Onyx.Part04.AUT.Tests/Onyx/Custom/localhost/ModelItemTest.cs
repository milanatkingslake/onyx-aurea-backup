...
namespace Avolin.Onyx.Part04.AUT.Tests.Onyx.Custom.localhost
{
    ...
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="Onyx.Custom.localhost.ModelItem" />)
    ///     and namespace <see cref="Onyx.Custom.localhost"/> class using generator(v:0.2.5)'s
    ///     artificial intelligence. Compatible with <see cref="AUT.TestProjects.GenV3" /> v1.2+.
    /// </summary>
    [TestFixture]
    [ExcludeFromCodeCoverage]
    public partial class ModelItemTest : AbstractBaseSetupV3Test
    {
        /// <summary>
        ///     Automatic Unit Tests for a public class (<see cref="ModelItem" />)
        /// </summary>
        public ModelItemTest() : base(typeof(ModelItem))
        { }
        ...
        public override void OneTimeSetup()
        {
            ...
            _modelItemInstanceFixture = this.Create<ModelItem>(false);
            _modelItemInstance = _modelItemInstanceFixture ?? this.Create<ModelItem>(true);
            CurrentInstance = _modelItemInstance;
        ...
        #region General Initializer : Class (ModelItem) Explore Non-listed Methods

        /// <summary>
        ///     Class (<see cref="ModelItem" />) explore and verify methods for coverage gain which is not listed in the constants.
        /// </summary>
        [Test]
        ...
        public void AUT_ModelItem_Explore_Reflection_Based_NonListed_Methods_Test()
        {
            // Arrange
        ...
        #region General Initializer : Class (ModelItem) Explore Non-listed Properties

        /// <summary>
        ///     Class (<see cref="ModelItem" />) explore and verify properties for coverage gain which is not listed in the constants.
        /// </summary>
        [Test]
        [Timeout(TestContants.TimeOutFortySeconds)]
        [NUnit.Framework.Category("AUT Reflection NonListed")]
        [NUnit.Framework.Category("AUT Slow Tests")]
        [NUnit.Framework.Category("AUT Explore")]
        public void AUT_ModelItem_Explore_Reflection_Based_NonListed_Properties_Test()
        {
            // Arrange
        ...
        #region General Initializer : Class (ModelItem) Explore Non-listed Fields

        /// <summary>
        ///     Class (<see cref="ModelItem" />) explore and verify fields for coverage gain which is not listed in the constants.
        /// </summary>
        [Test]
        [Timeout(TestContants.TimeOutFortySeconds)]
        [NUnit.Framework.Category("AUT Reflection NonListed")]
        [NUnit.Framework.Category("AUT Slow Tests")]
        [NUnit.Framework.Category("AUT Explore")]
        public void AUT_ModelItem_Explore_Reflection_Based_NonListed_Fields_Test()
        {
            // Arrange
        ...
        #region General Instance : Class (ModelItem) Static Class or Instance Creation
        ...
        #region General Instance : Class (ModelItem) Instance Type Verify Test

        /// <summary>
        ///     Class (<see cref="ModelItem" />) instance type verify test.
        /// </summary>
        [Test]
        [Timeout(TestsTimeOut)]
        [NUnit.Framework.Category("AUT Instance")]
        public void AUT_ModelItem_Is_Instance_Type_Verify_Test()
        {
            // Assert
            _modelItemInstance.ShouldBeAssignableTo<ModelItem>();
            _modelItemInstanceFixture.ShouldBeAssignableTo<ModelItem>();
            CurrentInstance.ShouldBeAssignableTo<ModelItem>();
        }
        ...
        public void AUT_ModelItem_Instantiated_Without_Parameter_No_Throw_Exception_Test()
        {
            // Arrange
        ...
        #region General Getters/Setters : Class (ModelItem) => all properties explore by setting value.
        ...
        [TestCase(PropertyDescription)]
        [TestCase(PropertyModelItems)]
        public void AUT_ModelItem_Property_Exist_By_Name_Verify_Test(string name)
        {
            // Arrange
            this.ValidateExecuteCondition(name);
            var propertyInfo = this.GetPropertyInfo(name);
        ...
        {
            // Arrange
            this.ValidateExecuteCondition(PropertyModelItems);
            var randomString = this.CreateType<string>();

            // Act
            var propertyInfo = this.GetPropertyInfo(PropertyModelItems);
        ...
        #region General Getters/Setters : Class (ModelItem) => Property (Type) Property Type Test Except String

        [Test]
        [Timeout(TestsTimeOut)]
        [NUnit.Framework.Category("AUT GetterSetter")]
        public void AUT_ModelItem_Type_Property_Setting_String_Throw_Argument_Exception_Test()
        {
            // Arrange
        ...
        #region General Getters/Setters : Class (ModelItem) => Property (Type) (Can Read) tests

        [Test]
        [Timeout(TestsTimeOut)]
        [NUnit.Framework.Category("AUT GetterSetter")]
        public void AUT_ModelItem_Public_Class_Type_Coverage_For_Property_Is_Present_And_Can_Read_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(PropertyType);
            var propertyInfo = this.GetPropertyInfo(PropertyType);
