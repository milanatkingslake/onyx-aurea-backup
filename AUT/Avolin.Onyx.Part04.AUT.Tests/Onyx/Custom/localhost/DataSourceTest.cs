...
namespace Avolin.Onyx.Part04.AUT.Tests.Onyx.Custom.localhost
{
    ...
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="Onyx.Custom.localhost.DataSource" />)
    ///     and namespace <see cref="Onyx.Custom.localhost"/> class using generator(v:0.2.5)'s
    ///     artificial intelligence. Compatible with <see cref="AUT.TestProjects.GenV3" /> v1.2+.
    /// </summary>
    [TestFixture]
    [ExcludeFromCodeCoverage]
    public partial class DataSourceTest : AbstractBaseSetupV3Test
    {
        /// <summary>
        ///     Automatic Unit Tests for a public class (<see cref="DataSource" />)
        /// </summary>
        public DataSourceTest() : base(typeof(DataSource))
        { }
        ...
        public override void OneTimeSetup()
        {
            ...
            _dataSourceInstanceFixture = this.Create<DataSource>(false);
            _dataSourceInstance = _dataSourceInstanceFixture ?? this.Create<DataSource>(true);
            CurrentInstance = _dataSourceInstance;
        ...
        #region General Initializer : Class (DataSource) Explore Non-listed Methods

        /// <summary>
        ///     Class (<see cref="DataSource" />) explore and verify methods for coverage gain which is not listed in the constants.
        /// </summary>
        [Test]
        ...
        public void AUT_DataSource_Explore_Reflection_Based_NonListed_Methods_Test()
        {
            // Arrange
        ...
        #region General Initializer : Class (DataSource) Explore Non-listed Properties

        /// <summary>
        ///     Class (<see cref="DataSource" />) explore and verify properties for coverage gain which is not listed in the constants.
        /// </summary>
        [Test]
        [Timeout(TestContants.TimeOutFortySeconds)]
        [NUnit.Framework.Category("AUT Reflection NonListed")]
        [NUnit.Framework.Category("AUT Slow Tests")]
        [NUnit.Framework.Category("AUT Explore")]
        public void AUT_DataSource_Explore_Reflection_Based_NonListed_Properties_Test()
        {
            // Arrange
        ...
        #region General Initializer : Class (DataSource) Explore Non-listed Fields

        /// <summary>
        ///     Class (<see cref="DataSource" />) explore and verify fields for coverage gain which is not listed in the constants.
        /// </summary>
        [Test]
        [Timeout(TestContants.TimeOutFortySeconds)]
        [NUnit.Framework.Category("AUT Reflection NonListed")]
        [NUnit.Framework.Category("AUT Slow Tests")]
        [NUnit.Framework.Category("AUT Explore")]
        public void AUT_DataSource_Explore_Reflection_Based_NonListed_Fields_Test()
        {
            // Arrange
        ...
        #region General Instance : Class (DataSource) Static Class or Instance Creation
        ...
        #region General Instance : Class (DataSource) Instance Type Verify Test

        /// <summary>
        ///     Class (<see cref="DataSource" />) instance type verify test.
        /// </summary>
        [Test]
        [Timeout(TestsTimeOut)]
        [NUnit.Framework.Category("AUT Instance")]
        public void AUT_DataSource_Is_Instance_Type_Verify_Test()
        {
            // Assert
            _dataSourceInstance.ShouldBeAssignableTo<DataSource>();
            _dataSourceInstanceFixture.ShouldBeAssignableTo<DataSource>();
            CurrentInstance.ShouldBeAssignableTo<DataSource>();
        }
        ...
        public void AUT_DataSource_Instantiated_Without_Parameter_No_Throw_Exception_Test()
        {
            // Arrange
        ...
        #region General Getters/Setters : Class (DataSource) => all properties explore by setting value.
        ...
        [TestCase(PropertyName)]
        [TestCase(PropertyItem)]
        public void AUT_DataSource_Property_Exist_By_Name_Verify_Test(string name)
        {
            // Arrange
            this.ValidateExecuteCondition(name);
            var propertyInfo = this.GetPropertyInfo(name);
