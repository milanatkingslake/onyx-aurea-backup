...
namespace Avolin.Onyx.Part04.AUT.Tests.Onyx.Custom
{
    ...
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="Onyx.Custom.OnyxObject" />)
    ...
    public class OnyxObjectTest : AbstractBaseSetupV3Test
    {
        ...
        public void AUT_OnyxObject_Constructor_With_Parameter_Created_Instance_Type_Test()
        {
            ...
            // Act
            Action createAction = () => instance = new OnyxObject(paramPrimaryId, ObjectType);
        ...
        [ExcludeFromCodeCoverage]
        private void AUT_OnyxObject_logObjectDetails_Method_Call_Internally(Type[] types)
        {
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_OnyxObject_logObjectDetails_Method_DirectCall_No_Exception_Thrown_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodlogObjectDetails);

            // Act
            Action executeAction = () => _onyxObjectInstance.logObjectDetails();
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_OnyxObject_logObjectDetails_Method_Call_Void_With_No_Parameters_No_Exception_Thrown_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodlogObjectDetails);
            ...
            // Act
            Action currentAction = () => currentMethodInfo.Invoke(_onyxObjectInstanceFixture, parametersOflogObjectDetails);
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_OnyxObject_logObjectDetails_Method_Call_Void_With_No_Parameters_Call_No_Exception_Thrown_With_Encapsulation_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodlogObjectDetails);
            Type [] methodlogObjectDetailsParametersTypes = null;
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_OnyxObject_logObjectDetails_Method_Call_Dynamic_Invoking_Should_Not_Throw_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodlogObjectDetails);
            Type [] methodlogObjectDetailsParametersTypes = null;
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_OnyxObject_logObjectDetails_Method_Call_With_Dynamic_Invoking_Without_Parameters_Should_Not_Throw_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodlogObjectDetails);
