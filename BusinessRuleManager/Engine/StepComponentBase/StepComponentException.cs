...
{
	/// <summary>
	/// Exception class for step component exception handling.
	/// </summary>
	public class StepComponentException : ApplicationException
	{
		...
		/// <summary>
		/// National Language message ID related to the exception.
		/// </summary>
		...
		/// Default constructor.
		/// </summary>
		public StepComponentException() : base()
		{
		}

		/// <summary>
        /// Constructor used when a National Language message ID is provided.
		/// </summary>
		/// <param name="psSource">Source of the exception.</param>
		/// <param name="plMessageId">National Language message ID to use for the error message.</param>
		...
		public StepComponentException(string psSource,
			long plMessageId,
		...
		/// <summary>
        /// Constructor used when a National Language message ID is not provided.
		/// </summary>
		/// <param name="psSource">Source of the exception.</param>
